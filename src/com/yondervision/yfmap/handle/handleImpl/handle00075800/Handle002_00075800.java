...
public class Handle002_00075800 implements CtrlHandleInter {
	...
	public ModelMap action(AppApiCommonForm form1, ModelMap modelMap) throws CenterRuntimeException,Exception{
		...
		if(Constants.method_XML.equals(send)){////xml通信处理
			...
			String reqxml = CommunicateUtil.sendMessage(send, ip, Integer.parseInt(port), xml, "A00015");
			...
			if(filename!=null){
				...
				while (line != null) {// 判断读取到的字符串是否不为空
					...
					try {
						...
						aa00201Result.setBusiamt1(param[1]);
