 ...
 * 余额明细查询
 */
public class Handle002_00031500 implements CtrlHandleInter {
...
//			HashMap resultMap = MessageCtrMain.analysisPacket(msgType, "C:/Program Files/Tomcat 6.0/webapps/YFMAP/WEB-INF/classes/com/yondervision/yfmap/config/messagetemp/00053100/REP_YEMXCX.xml", rexml, req);
			...
			if(filename!=null){
				...
				while (line != null) {// 判断读取到的字符串是否不为空
					...
					try {
						...
						aa00201Result.setOperationType(String.format("%.2f",Double.valueOf(valus[1]))+"元");
						aa00201Result.setAmount(String.format("%.2f",Double.valueOf(valus[2]))+"元");
		...
		modelMap.put("total", app002Result.getCount());
		return modelMap;
	}
	...
	public static void main(String[] args){
		...
		Handle002_00031500 hand = new Handle002_00031500();
		try {
