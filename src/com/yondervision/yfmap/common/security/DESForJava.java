...
public class DESForJava {
	 ...
	 * @throws UnsupportedEncodingException
	 */
	public static byte[] encryption(String msg,byte[] key) throws UnsupportedEncodingException{
		//[padding模式]:明文长度,不是8的倍数的,需要用空格补齐
		if(msg.getBytes().length%8!=0){
			msg = msg + "        ".substring(msg.getBytes().length%8);
		}
		byte[] ret = reportdes(msg.getBytes(),key,msg.getBytes().length,0);
		return ret;
	} 
	 ...
	 * @throws UnsupportedEncodingException
	 */
	public static String decryption(byte[] msg,byte[] key) throws UnsupportedEncodingException{
		int l = msg.length;
		int num = msg.length;
		while( l % 8 != 0 )
		{			
...
//		byte[] ret = reportdes(msg,key,msg.length,1);
		byte[] ret = reportdes(clonemsg,key,clonemsg.length,1);
	...
	public static void main(String[] args) throws UnsupportedEncodingException {
		...
		/*
		 * 重要说明：
		 * C语言中的加密算法，传入的明文长度要求必须是8的倍数，所以不够8的需要加空格补齐。
		 * java版本的会自动补齐，所以不要自己再补了
		 */		
		
//		String value2 = "g ekwllwekoo019191991913";
//		System.out.println(":::::::"+value2);
//		byte[] a2 = value2.getBytes();
//
//		byte[] b2 = DESForJava.encryption(value2, "123221".getBytes());
//		String s2 = DESForJava.decryption(b2, "123221".getBytes());
//		System.out.println("Java语言来解密C语言加密的内容:"+s2);
		
		
//		JNIDES jnides = new JNIDES();		
		String value1 = "<?xml version=\"1.0\" encoding = \"UTF-8\"?><mi><head><transCode>3001</transCode><sendDate>1</sendDate><sendTime>1</sendTime><sendSeqno>1</sendSeqno><key>1</key><longinip>1</longinip><buzType>1</buzType></head><body><accnum>1</accnum><title>1</title><detail>1</detail><theme>1</theme><freeuse1>1</freeuse1><freeuse2>1</freeuse2><freeuse3>1</freeuse3></body></mi>";
//		String value1 = "<?xml version='1.0' encoding='GBK'?> <root> <head> <reqflag>0</reqflag> <msgtype>21</msgtype> <tr_code>A00023</tr_code> <corp_no>0231</corp_no> <user_no>0231</user_no> <req_no>0311031301290000510E</req_no> <oreq_no>0311031301290000510E</oreq_no> <tr_acdt>2012-12-11</tr_acdt> <tr_time>160733</tr_time> <channel>09</channel> <sign>03</sign> <key /> <reserved /> </head> <body> <acctno>100384418432</acctno> <acctname>河北中行对公测试唐山11</acctname> <free_use1 /> <free_use2 /> <free_use3 /> <free_use4 /> <free_use5 /> <free_use6 /> </body> </root>";
		System.out.println(value1);
		
//		byte[] a1 = value1.getBytes();
//		byte[] b1 = jnides.jniEncryption(value1, "981621", a1.length);
//		System.out.println("加密前："+b1.toString());
//		String s = DESForJava.decryption(b1, "981621".getBytes());
//		System.out.println("Java语言来解密C语言加密的内容:"+s);	
		
		byte[] kkk = DESForJava.encryption(value1, "551209".getBytes());
		System.out.println(value1);
		System.out.println(new String(kkk));
		
//		String leeString = jnides.jniDecryption(kkk, "873212", kkk.length);
//		System.out.println(leeString);
		
		String ms = DESForJava.decryption(kkk, "551209".getBytes());
		System.out.println("解密后明文："+ms);
		
		
//		String s = "g ekwllwekoo01919199191";
//		String key = "123221";
//		byte[] b = DESForJava.encryption(s, key.getBytes());
//		for(byte bb:b){
//			System.out.printf("%h,",bb);
//		}
//		
//		String ret = DESForJava.decryption(b, key.getBytes());
//		System.out.println();
//		System.out.println("解密："+ret);
		
		
		//String plaintext = "12345678asdfghjka       我是中国人      ";
//		String plaintext="<?xml version=\"1.0\" encoding=\"GBK\"?> <root> <head> <reqflag>0</reqflag> <msgtype>21</msgtype> <tr_code>A00023</tr_code> <corp_no>0231</corp_no> <user_no>0231</user_no> <req_no>0311031301290000510E</req_no> <oreq_no>0311031301290000510E</oreq_no> <tr_acdt>2012-12-11</tr_acdt> <tr_time>160733</tr_time> <channel>09</channel> <sign>03</sign> <key /> <reserved /> </head> <body> <acctno>100384418432</acctno> <acctname>河北中行对公测试唐山11</acctname> <free_use1 /> <free_use2 /> <free_use3 /> <free_use4 /> <free_use5 /> <free_use6 /> </body> </root>   ";
//		String plaintext2="<?xml version=\"1.0\" encoding=\"GBK\"?> <root> <head> <reqflag>0</reqflag> <msgtype>21</msgtype> <tr_code>A00023</tr_code> <corp_no>0231</corp_no> <user_no>0231</user_no> <req_no>0311031301290000510E</req_no> <oreq_no>0311031301290000510E</oreq_no> <tr_acdt>2012-12-11</tr_acdt> <tr_time>160733</tr_time> <channel>09</channel> <sign>03</sign> <k";
//		String plaintext3="<?xml version=\"1.0\" encoding=\"GBK\"?> <root> <head> <reqflag>0</reqflag> <msgtype>21</msgtype> <tr_code>A00023</tr_code> <corp_no>0231</corp_no> <user_no>0231</user_no> <req_no>0311031301290000510E</req_no> <oreq_no>0311031301290000510E</oreq_no> <tr_acdt>2012-12-11</tr_acdt> <tr_time>160733</tr_time> <channel>09</channel> <sign>03</sign> <key /> <reserved /> </head> <body> <acctno>100384418432</acctno> <acctname>河北中行对公测试唐山11</acctname> <free_use1 /> <free_use2 /> <free_use3 /> <free_use4 /> <free_use5 /> <free_use6 /> </body> </root>   ";
//		String plaintext4="<?xml version=\"1.0\" encoding=\"GBK\"?> <root> <head> <reqflag>0</reqflag> <msgtype>21</msgtype> <tr_code>A00023</tr_code> <corp_no>0231</corp_no> <user_no>0231</user_no> <req_no>0311031301290000510E</req_no> <oreq_no>0311031301290000510E</oreq_no> <tr_acdt>2012-12-11</tr_acdt> <tr_time>160733</tr_time> <channel>09</channel> <sign>03</sign> <key /> <reserved /> </head> <body> <acctno>100384418432</acctno> <acctn";
//		String plaintext5="<?xml version=\"1.0\" encoding=\"GBK\"?> <root> <head> <reqflag>0</reqflag> <msgtype>21</msgtype> <tr_code>A00023</tr_code> <corp_no>0231</corp_no> <user_no>0231</user_no> <req_no>0311031301290000510E</req_no> <oreq_no>0311031301290000510E</oreq_no> <tr_acdt>2012-12-11</tr_acdt> <tr_time>160733</tr_time> <channel>09</channel> <sign>03</sign> <key /> <reserved /> </head> <body> <acctno>100384418432</acctno> <acctname>河北中行对公测试唐山11</acctname> <free_use1 /> <free_use2 /> <fre";
//		String plaintext6="<?xml version=\"1.0\" encoding=\"GBK\"?> <root> <head> <reqflag>0</reqf   ";
//		String plaintext7="<?xml version=\"1.0\" encoding=\"GBK\"?> <root> <head> <reqflag>0</reqflag> <msgtype>21</msgtype> <tr_code>A00023</tr_code> <corp_no>0231</corp_no> <user_no>0231</user_no> <req_no>0311031301290000510E</req_no> <oreq_no>0311031301290000510E</oreq_no> <tr_acdt>2012-12-11</tr_acdt> <tr_time>160733</tr_time> <channel>09</channel> <sign>03</sign> <key /> <reserved /> </head> <body> <acctno>100384418432</acctno> <acctname>河北中行对公测试唐山11</acctname> <free_use1 /> <free_use2 /> <free_use3 /> <free_use4 /> <free_use5 /> <free_use6 /> </body> </root>   ";
//		String plaintext8="<?xml version=\"1.0\" encoding=\"GBK\"?> <root> <head> <reqflag>0</reqflag> <msgtype>21</msgtype> <tr_code>A00023</tr_code> <corp_no>0231</corp_no";
//		String plaintext9="<?xml version=\"1.0\" encoding=\"GBK\"?> <root> <head> <reqflag>0</reqflag> <msgtype>21</msgtype> <tr_code>A00023</tr_code> <corp_no>0231</corp_no> <user_no>0231</user_no> <req_no>03110313012900005 ";
//		String plaintext10="<?xml version=\"1.0\" encoding=\"GBK\"?> <root> <head> <reqflag>0</reqflag> <msgtype>21</msgtype> <tr_code>A00023</tr_code> <corp_no>0231</corp_no> <user_no>0231</user_no> <req_no>0311031301290000510E</req_no> <oreq_no>0311031301290000510E</oreq_no> <tr_acdt>2012-12-11</tr";
//		
...
//		msg[9] = plaintext10;
//		
//		String[] keys = {"123456","323436","555436","323996","326476","828436","913736","098345","018335","999343"};
//		
//		System.out.println("明文长度："+plaintext.getBytes().length);
//		
//		byte[] ciphertext ;
//		int i=0;
////		ciphertext = JNIDES.jniEncryption(plaintext, key, plaintext.getBytes().length);
//		for(String key : keys){
//			i++;
//			ciphertext = DESForJava.encryption(msg[i], key.getBytes());
//			System.out.println("Java加密后长度：len3:"+ciphertext.length);
//			System.out.println("Jvaa语言加密后内容:");
//			for(byte b : ciphertext){
//				System.out.printf("%h,", b);
//			}
//			
//			System.out.println("C语言加密后长度：len2:"+ciphertext.length);
//			System.out.println("C语言加密后内容:");
//			for(byte b : ciphertext){
//				System.out.printf("%h,", b);
//			}
//			System.out.println();
//			String s = DESForJava.decryption(ciphertext, key.getBytes());
//			System.out.println("Java语言来解密C语言加密的内容："+s);
//		
//		}
	}
