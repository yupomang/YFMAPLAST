...
public class Handle00127_00057400 implements CtrlHandleInter {
...
//				form.setBrcCode(PropertiesReader.getProperty(PROPERTIES_FILE_NAME, "appapi001BrcCode"+form.getCenterId()).trim());
			...
			String xml = MessageCtrMain.encapsulatedPackets(msgType, CommonUtil.getFullURL(Constants.msgPath+form.getCenterId())+"/BSP_REQ_YHKJY.txt", map, req);
			...
			String rexml = CommunicateUtil.sendMessage(send, ip, Integer.parseInt(port), xml, "193000");			
			...
			log.debug("前置YFMAP接收中心报文——银行卡校验："+rexml);
			HashMap resultMap = MessageCtrMain.analysisPacket(msgType, CommonUtil.getFullURL(Constants.msgPath+form.getCenterId())+"/BSP_REP_YHKJY.txt", rexml, req);
		...
		modelMap.put("msg", "成功");			
		modelMap.put("bankfhinfo", app00126ZHResult.getBankfhinfo());
		modelMap.put("message", app00126ZHResult.getMessage());
		modelMap.put("state", app00126ZHResult.getState());
		modelMap.put("sysstate", app00126ZHResult.getSysstate());
		modelMap.put("type", app00126ZHResult.getType());
		return modelMap;
	}
