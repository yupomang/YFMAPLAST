...
public class Handle02204_00066800 implements CtrlHandleInter1{
	...
	public ModelMap action(AppApiCommonForm form1, ModelMap modelMap, HttpServletRequest request, HttpServletResponse response) throws CenterRuntimeException, Exception {
		...
		log.debug("00066800请求02204参数："+CommonUtil.getStringParams(form));
	...
	/*public static void main(String[] args){
		...
		Handle02204_00066800 hand = new Handle02204_00066800();
		try {
