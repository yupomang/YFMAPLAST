...
public class Handle50026_00073300 implements CtrlHandleInter1{
	...
	public ModelMap action(AppApiCommonForm form1, ModelMap modelMap, HttpServletRequest request, HttpServletResponse response) throws CenterRuntimeException, Exception {
		...
		log.debug("00073300请求50026参数："+CommonUtil.getStringParams(form));
		...
		if(Constants.method_BSP.equals(send)){////xml通信处理
			...
			//String xml = MessageCtrMain.encapsulatedPackets(msgType, "E:/mcq/workspaceEclipse/YFMAP/src/com/yondervision/yfmap/config/messagetemp/00073300/BSP_REQ_YHZHYXXYZ.txt", map, req);
			...
			//HashMap resultMap = MessageCtrMain.analysisPacket(msgType, "E:/mcq/workspaceEclipse/YFMAP/src/com/yondervision/yfmap/config/messagetemp/00073300/BSP_REP_YHZHYXXYZ.txt", rexml, req);
	...
	/*public static void main(String[] args){
		...
		Handle50026_00073300 hand = new Handle50026_00073300();
		try {
