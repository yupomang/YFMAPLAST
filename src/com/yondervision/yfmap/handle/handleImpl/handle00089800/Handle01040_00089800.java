 ...
 *
 */
public class Handle01040_00089800 implements CtrlHandleInter {
	...
	public ModelMap action(AppApiCommonForm form1, ModelMap modelMap) throws CenterRuntimeException,Exception{
		...
		log.info(Constants.LOG_HEAD+"appApi01040 start.");
...
//		mapPool.put("_PORCNAME", "还款方式变更");
//		mapPool.put("_PROCID", "60031013");
//		
//		mapPool.put("flowid", "297");
//		mapPool.put("counter", "1");
//		mapPool.put("selorgid", "08981302");
//		mapPool.put("stepid", "3");
		mapPool.put("loanreason", form.getChangeReason());
		mapPool.put("newrepaymode", form.getDkhkfs());
		
		try {
			String flag = "40"+form.getCenterId();
			...
			//TODO 存数据库异常错误码
			modelMap.put("recode", "999999");
			modelMap.put("msg", "还款方式变更存数据库异常");
			log.error("还款方式变更存数据库异常："+e.getMessage());
			e.printStackTrace();
			return modelMap;
		}
