 ...
 * 提取签约-01-退休销户
 */
public class Handle0100701_00031500 implements CtrlHandleInter {
...
//				return modelMap;
//			}
			String xml = MessageCtrMain.encapsulatedPackets(msgType, CommonUtil.getFullURL(Constants.msgPath+form.getCenterId())+"REQ_TQQY01.xml", map, req);
...
//					"</body></root>";
			...
			HashMap resultMap = MessageCtrMain.analysisPacket(msgType, CommonUtil.getFullURL(Constants.msgPath+form.getCenterId())+"REP_TQQY01.xml", rexml, req);
//			HashMap resultMap = MessageCtrMain.analysisPacket(msgType, "D:/server/apache-tomcat-6.0.44/webapps/ydmi_csp/WEB-INF/classes/com/yondervision/yfmap/config/messagetemp/00053100/REP_TQQY01.xml", rexml, req);
		...
		modelMap.put("msg", "您提交的退休且封存销户提取申请已受理，资金将于2个工作日内到账联名卡账户，请注意查收。");
	...
	public static void main(String[] args){
		...
		Handle0100701_00031500 hand = new Handle0100701_00031500();
		try {
