...
public class Handle04501_00057400 implements CtrlHandleInter {
...
//				form.setBrcCode(PropertiesReader.getProperty(PROPERTIES_FILE_NAME, "appapi001BrcCode"+form.getCenterId()).trim());
			...
			//String xml = MessageCtrMain.encapsulatedPackets(msgType, "D:/workzone/YFMAP/src/com/yondervision/yfmap/config/messagetemp/00057400/BSP_REQ_DWYW_BJDJ.txt", map, req);
			log.debug("前置YFMAP发往中心报文："+xml);			
			String ip = PropertiesReader.getProperty(PROPERTIES_FILE_NAME, "BSP_SOCKET_IP"+form.getCenterId()).trim();
			String port = PropertiesReader.getProperty(PROPERTIES_FILE_NAME, "BSP_SOCKET_PORT"+form.getCenterId()).trim();
			String rexml = CommunicateUtil.sendMessage(send, ip, Integer.parseInt(port), xml, "111401");			
			//String rexml ="<AuthCode1>7710</><AuthCode2>7710</><AuthCode3>7710</><AuthFlag></><BrcCode>05740008</><BusiSeq>92642</><ChannelSeq>12357751</><ChkCode>7710</><MTimeStamp>2017-08-15 20:30:58:18000</><NoteMsg></><RspCode>000000</><RspMsg>交易处理成功...</><STimeStamp>2017-08-15 20:30:58:179000</><TellCode>7710</><TranChannel>00</><TranCode>111401</><TranDate>2017-08-11</><TranIP>172.16.8.100</><TranSeq>92642</><regnum>2017081192642</><rsufilename>aaa</><rsufilepath>vvvv</>";
			
			log.debug("前置YFMAP接收中心报文——个人补缴："+rexml);
		    ...
		    //HashMap resultMap = MessageCtrMain.analysisPacket(msgType, "D:/workzone/YFMAP/src/com/yondervision/yfmap/config/messagetemp/00057400/BSP_REP_DWYW_BJDJ.txt", rexml, req);
		...
		System.out.println("查询批量文件："+app04501ZHResult.getFilename());
		modelMap.clear();
		modelMap.put("recode", "000000");
		modelMap.put("msg", "成功");
		modelMap.put("rsufilename", app04501ZHResult.getFilename());
		modelMap.put("rsufilepath", app04501ZHResult.getFilepath());
		modelMap.put("regnum", app04501ZHResult.getRegnum());
		return modelMap;
	}
