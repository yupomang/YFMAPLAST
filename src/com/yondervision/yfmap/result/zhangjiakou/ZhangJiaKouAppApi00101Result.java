 ...
 *
 */
public class ZhangJiaKouAppApi00101Result {
	/** 身份证号 */						
	...
	/** 月缴存金额 */						
	private String monthPaymentSum = "";	
	/** 冻结金额 */						
	...
	public String getYearExtraction() {
		return yearExtraction;
	}
	public void setYearExtraction(String yearExtraction) {
		this.yearExtraction = yearExtraction;
	}
	public String getMonthPaymentSum() {
		return monthPaymentSum;
	}
	public void setMonthPaymentSum(String monthPaymentSum) {
		this.monthPaymentSum = monthPaymentSum;
	}
