...
public class Handle003_00076000 implements CtrlHandleInter {
	...
	public ModelMap action(AppApiCommonForm form1, ModelMap modelMap)
		...
		if(Constants.method_XML.equals(send)){////xml通信处理
			...
			String rexml = CommunicateUtil.sendMessage(send, ip, Integer.parseInt(port), xml, "119014");
			
			
//			String rexml = "<?xml version=\"1.0\" encoding = \"UTF-8\"?><mi><head><transCode>appapi001</transCode><recvDate>2015-07-30</recvDate><recvTime>14:30:30</recvTime><sendSeqno>12345678</sendSeqno><key></key><centerSeqno>123456</centerSeqno><recode>000000</recode><msg>success</msg></head><body><accnum>2015-07-01</accnum><accname>123</accname><intdate>adf</intdate><intamt>12345</intamt><bal>2015-06-01</bal></body></mi>";
			...
			if(!"000000".equals(appApi00301Result.getRecode())){
