...
import com.yondervision.yfmap.result.zhangjiakou.ZhangJiaKouAppApi00802_2Result;
import com.yondervision.yfmap.result.zhangjiakou.ZhangJiaKouAppApi00802_1Result;
 ...
 * 楼盘信息查询
 */
public class Handle00802_00031300 implements CtrlHandleInter {
	...
	public ModelMap action(AppApiCommonForm form1, ModelMap modelMap) throws CenterRuntimeException,Exception{
		...
		form.setPagenum(String.valueOf((Integer.valueOf(form.getPagenum()))));
		ZhangJiaKouAppApi00802_1Result app00802Result=new ZhangJiaKouAppApi00802_1Result(); // 表头
		//TangShanAppApi00802_1Result app00802Result = new TangShanAppApi00802_1Result();
		List<ZhangJiaKouAppApi00802_2Result> list = new ArrayList<ZhangJiaKouAppApi00802_2Result>();
		AES aes = new AES();
		...
		log.debug("YFMAP aes可贷楼盘查询 楼盘名称 参数:"+form.getSelectValue());
		log.debug("YFMAP aes可贷楼盘查询 楼盘名称 参数:"+form.getSelectType());
		//if(!CommonUtil.isEmpty(form.getSelectValue()))form.setSelectValue(aes.decrypt(form.getSelectValue()));
		//if(!CommonUtil.isEmpty(form.getSelectType()))form.setSelectType(aes.decrypt(form.getSelectType()));
...
//			HashMap resultMap = MessageCtrMain.analysisPacket(msgType,"C:/Program Files/Tomcat 6.0/webapps/YFMAP/WEB-INF/classes/com/yondervision/yfmap/config/messagetemp/00053100/REP_KDLPCX.xml", rexml, req);
			...
			if(filename!=null){
				...
				while (line != null) {// 判断读取到的字符串是否不为空
					ZhangJiaKouAppApi00802_2Result aa00802Result = new ZhangJiaKouAppApi00802_2Result();
					try {
						...
						if(valus.length>4)aa00802Result.setLxdh(valus[4]);
						if(valus.length>5)aa00802Result.setYsxkz(valus[5]);
						if(valus.length>6)aa00802Result.setKdld(valus[6]);
	...
	public static void main(String[] args){
		...
		form1.setPagenum("10");
		form1.setPagerows("0");
		Handle00802_00031300 hand = new Handle00802_00031300();
		try {
