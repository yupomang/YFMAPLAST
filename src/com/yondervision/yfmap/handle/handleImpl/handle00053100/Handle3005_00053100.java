...
public class Handle3005_00053100 extends AbsBusinessServer {
	...
	public String acction(String xml, OutputStream out, String centerid, String seq)
		...
		log.debug("Handle3005_00053100:开始****处理短消息批量推送逻辑");
		...
		if(Constants.method_XML.equals(send)){////xml通信处理
			...
			HashMap resultMap;
			try {
				log.debug("Handle3005_00053100 接收报文: "+xml);
	...
	public static void main(String[] args){
		...
		Handle3005_00053100 hand = new Handle3005_00053100();
