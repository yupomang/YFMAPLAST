 ...
 * 单位信息公共查询
 */
public class AppApi02003ZHResult {
	/** 状态码*/
	...
	/** 汇缴金额变动增加金额*/
	private String chgaddpayamt = "";
	/** 汇缴金额变动减少金额*/
	private String chgdecpayamt = "";
	/** 销户日期*/
	...
	/** 预缴账户冻结金额*/
	private String unitprefrzamt = "";
	/** 预缴账户止付余额*/
	private String unitpresamt = "";
	/** 单位比例*/
	private String unitprop = "";
	/** 单位特殊比例*/
	private String unitspeprop = "";
	/** 预缴户可用余额*/
	private String upreusebal = "";
	/** 在职人数*/
	private String workernum = "";
	/** 组织机构代码*/
	private String zzjgdm = "";
	/** 单位销户人数*/
	private String dwxhrs = "";
	/** 单位账号*/
	private String dwzh = "";
	/** 单位预缴账号*/
	...
	public String getHigpropflag() {
		return higpropflag;
	}
	public void setHigpropflag(String higpropflag) {
		this.higpropflag = higpropflag;
	}
	...
	public String getIntaccu() {
		return intaccu;
	}
	public void setIntaccu(String intaccu) {
	...
	public String getAllexchgflag() {
		return allexchgflag;
	}
	public void setAllexchgflag(String allexchgflag) {
		this.allexchgflag = allexchgflag;
	}
	...
	public String getBfchgindiprop() {
		return bfchgindiprop;
	}
	public void setBfchgindiprop(String bfchgindiprop) {
		this.bfchgindiprop = bfchgindiprop;
	}
	...
	public String getChgaddpayamt() {
		return chgaddpayamt;
	}
	public void setChgaddpayamt(String chgaddpayamt) {
		this.chgaddpayamt = chgaddpayamt;
	}
	public String getChgdecpayamt() {
		return chgdecpayamt;
	}
	public void setChgdecpayamt(String chgdecpayamt) {
		this.chgdecpayamt = chgdecpayamt;
	}
	...
	public String getCstcollno() {
		return cstcollno;
	}
	public void setCstcollno(String cstcollno) {
		this.cstcollno = cstcollno;
	}
	...
	public String getMorecheflag() {
		return morecheflag;
	}
	public void setMorecheflag(String morecheflag) {
		this.morecheflag = morecheflag;
	}
	...
	public String getOnym() {
		return onym;
	}
	public void setOnym(String onym) {
		this.onym = onym;
	}
	...
	public String getSincolflag() {
		return sincolflag;
	}
	public void setSincolflag(String sincolflag) {
		this.sincolflag = sincolflag;
	}
	...
	public String getUnitprefrzamt() {
		return unitprefrzamt;
	}
	public void setUnitprefrzamt(String unitprefrzamt) {
		this.unitprefrzamt = unitprefrzamt;
	}
	public String getUnitpresamt() {
		return unitpresamt;
	}
	public void setUnitpresamt(String unitpresamt) {
		this.unitpresamt = unitpresamt;
	}
	...
	public String getUpreusebal() {
		return upreusebal;
	}
	public void setUpreusebal(String upreusebal) {
		this.upreusebal = upreusebal;
	}
	...
	public String getDwxhrs() {
		return dwxhrs;
	}
	public void setDwxhrs(String dwxhrs) {
		this.dwxhrs = dwxhrs;
	}
