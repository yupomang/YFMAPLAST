...
public class Handle03827_00057400 implements CtrlHandleInter {
...
//				form.setBrcCode(PropertiesReader.getProperty(PROPERTIES_FILE_NAME, "appapi001BrcCode"+form.getCenterId()).trim());
		    ...
		    String xml = MessageCtrMain.encapsulatedPackets(msgType, CommonUtil.getFullURL(Constants.msgPath+form.getCenterId())+"/BSP_REQ_ZGZFGJJJCQKZMYL.txt", map, req);
			//String xml = MessageCtrMain.encapsulatedPackets(msgType, "D:/workzone/YFMAP/src/com/yondervision/yfmap/config/messagetemp/00057400/BSP_REQ_ZGZFGJJJCQKZMYL.txt", map, req);
			log.debug("前置YFMAP发往中心报文："+xml);			
			String ip = PropertiesReader.getProperty(PROPERTIES_FILE_NAME, "BSP_SOCKET_IP"+form.getCenterId()).trim();
			String port = PropertiesReader.getProperty(PROPERTIES_FILE_NAME, "BSP_SOCKET_PORT"+form.getCenterId()).trim();
			String rexml = CommunicateUtil.sendMessage(send, ip, Integer.parseInt(port), xml, "128109");
			
			//String rexml ="<AuthCode1>1200</><AuthCode2>1200</><AuthCode3>1200</><AuthFlag>0</><BrcCode>05740008</><BusiSeq>105933</><ChannelSeq>12373581</><ChkCode>1200</><MTimeStamp>2017-09-15 16:57:52:635629</><NoteMsg></><RspCode>000000</><RspMsg>交易处理成功...</><STimeStamp>2017-09-05 18:12:47:745000</><TellCode>1200</><TranChannel>0</><TranCode>128109</><TranDate>2017-08-27</><TranIP>172.16.8.101</><TranSeq>105933</><accname>王小猛</><accnum>0116465583</><addr>无</><amt>0.00</><bal>15704.12</><basenum>8356.00</><certinum>412724198508088394</><flag>0</><indiaccstate>0</><indipaysum>2006.00</><indiprop>12.000</><loancontrnum>20170827nbbj03</><month></><month1></><opnaccdate>2013-09-16</><projectname>测试住房公积金中心</><unitaccname>中华人民共和国宁波海事局</><unitprop>12.000</><year></><year1></>";
			log.debug("前置YFMAP接收中心报文——职工住房公积金缴存情况证明预览："+rexml);
		    HashMap resultMap = MessageCtrMain.analysisPacket(msgType, CommonUtil.getFullURL(Constants.msgPath+form.getCenterId())+"/BSP_REP_ZGZFGJJJCQKZMYL.txt", rexml, req);
		    //HashMap resultMap = MessageCtrMain.analysisPacket(msgType, "D:/workzone/YFMAP/src/com/yondervision/yfmap/config/messagetemp/00057400/BSP_REP_ZGZFGJJJCQKZMYL.txt", rexml, req);
