...
public class Handle00911_00066800 implements CtrlHandleInter {
	...
	public ModelMap action(AppApiCommonForm form1, ModelMap modelMap)
		...
		log.debug("00066800请求00911参数："+CommonUtil.getStringParams(form));
	...
	/*public static void main(String[] args){
		...
		form1.setChannel("40");
		Handle00911_00066800 hand = new Handle00911_00066800();
		try {
