...
import com.yondervision.yfmap.result.ningbo.AppApi03801ZHResult;
...
public class Handle03801_00057400 implements CtrlHandleInter {
...
//				form.setBrcCode(PropertiesReader.getProperty(PROPERTIES_FILE_NAME, "appapi001BrcCode"+form.getCenterId()).trim());
			...
			//String xml = MessageCtrMain.encapsulatedPackets(msgType, "D:/workzone/YFMAP/src/com/yondervision/yfmap/config/messagetemp/00057400/BSP_REQ_DWYW_GRKH.txt", map, req);
			log.debug("前置YFMAP发往中心报文："+xml);			
			String ip = PropertiesReader.getProperty(PROPERTIES_FILE_NAME, "BSP_SOCKET_IP"+form.getCenterId()).trim();
			String port = PropertiesReader.getProperty(PROPERTIES_FILE_NAME, "BSP_SOCKET_PORT"+form.getCenterId()).trim();
			String rexml = CommunicateUtil.sendMessage(send, ip, Integer.parseInt(port), xml, "111405");
			
			//String rexml ="<AuthCode1>7710</><AuthCode2>7710</><AuthCode3>7710</><AuthFlag></><BrcCode>05740008</><BusiSeq>88808</><ChannelSeq>12354011</><ChkCode>7710</><MTimeStamp>2017-08-08 21:09:41:508000</><NoteMsg></><RspCode>000000</><RspMsg>交易处理成功...</><STimeStamp>2017-08-08 21:09:41:508000</><TellCode>7710</><TranChannel>00</><TranCode>118010</><TranDate>2017-08-10</><TranIP>172.16.8.100</><TranSeq>88808</>"
			//		+ "<rsufilename>cmprtf0002_10.2017081000089650</><rsufilepath>/bsptest/00000000/fil/</>";
		    ...
		    //HashMap resultMap = MessageCtrMain.analysisPacket(msgType, "D:/workzone/YFMAP/src/com/yondervision/yfmap/config/messagetemp/00057400/BSP_REP_DWYW_GRKH.txt", rexml, req);
			...
			if(!"0".equals(app03801ZHResult.getRecode())){
				if(!CommonUtil.isEmpty(app03801ZHResult.getMsg())){
					if("/".equals(app03801ZHResult.getMsg().substring(0,1))){
						FtpUtil f=new FtpUtil("bsp");
						f.getFileByServerForNB(app03801ZHResult.getMsg());	    
						File file = new File(ReadProperties.getString("bsp_local_path")+"/"+app03801ZHResult.getMsg());
						...
						log.error("中心返回报文 状态recode :"+app03801ZHResult.getRecode()+"  ,  描述msg : "+result.toString());
					}else{
						modelMap.clear();
						modelMap.put("recode", app03801ZHResult.getRecode());
						modelMap.put("msg", "错误信息："+app03801ZHResult.getMsg());
		...
		modelMap.put("msg", "成功");
		modelMap.put("rsufilename", app03801ZHResult.getRsufilename());
		modelMap.put("rsufilepath", app03801ZHResult.getRsufilepath());
		return modelMap;
	}
	...
	/*public static void main(String[] args){
		...
		Handle03801_00057400 hand = new Handle03801_00057400();
		try {
