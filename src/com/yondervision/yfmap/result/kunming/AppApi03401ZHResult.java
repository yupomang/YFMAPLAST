 ...
 *  退休提取
 */
public class AppApi03401ZHResult {
	...
	public String getDrawint() {
		return drawint;
	}
	public void setDrawint(String drawint) {
		this.drawint = drawint;
	}
	public String getHasgjjloan() {
		return hasgjjloan;
	}
	public void setHasgjjloan(String hasgjjloan) {
		this.hasgjjloan = hasgjjloan;
	}
