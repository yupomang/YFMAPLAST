...
import com.yondervision.yfmap.result.chengde.ChengDeAppApi00101Result;
...
public class Handle001_00031400 implements CtrlHandleInter {
	...
	public ModelMap action(AppApiCommonForm form1, ModelMap modelMap) throws CenterRuntimeException,Exception{
		...
		ChengDeAppApi00101Result app00101Result = new ChengDeAppApi00101Result();
...
//			HashMap resultMap = MessageCtrMain.analysisPacket(msgType,"C:/Program Files/Tomcat 6.0/webapps/YFMAP/WEB-INF/classes/com/yondervision/yfmap/config/messagetemp/00053100/REP_YECX.xml", rexml, req);
		...
		app00101Result.setMonthPaymentSum(String.format("%.2f",Double.valueOf(app00101Result.getMonthPaymentSum())));
		app00101Result.setYearExtraction(String.format("%.2f",Double.valueOf(app00101Result.getYearExtraction())));
		app00101Result.setCarryoverAmount(String.format("%.2f",Double.valueOf(app00101Result.getCarryoverAmount())));
		//app00101Result.setPersonalPaymentRate(String.format("%,.2f",Double.valueOf(app00101Result.getPersonalPaymentRate())));
