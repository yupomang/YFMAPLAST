...
public class Handle005_00076000 implements CtrlHandleInter {
	...
	public ModelMap action(AppApiCommonForm form1, ModelMap modelMap)
		...
		if(Constants.method_XML.equals(send)){////xml通信处理
			...
			String reqxml = CommunicateUtil.sendMessage(send, ip, Integer.parseInt(port), xml, "158002");			
			
//			String reqxml = "<?xml version=\"1.0\" encoding = \"UTF-8\"?><mi><head><transCode>appapi001</transCode><recvDate>2015-07-30</recvDate><recvTime>14:30:30</recvTime><sendSeqno>12345678</sendSeqno><key></key><centerSeqno>123456</centerSeqno><recode>000000</recode><msg>success</msg></head><body><detail><transdate>2015-07-01</transdate><drawreason>123</drawreason><drawamt>adf</drawamt></detail><detail><transdate>2015-06-01</transdate><drawreason>123</drawreason><drawamt>adf</drawamt></detail><detail><transdate>2015-05-01</transdate><drawreason>123</drawreason><drawamt>adf</drawamt></detail></body></mi>";
			...
			log.info("解析报文MAP："+resultMap);				
			BeanUtil.transMap2Bean(resultMap, app002Result);
			log.info("MAP封装成BEAN："+app002Result);
