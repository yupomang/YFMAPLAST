...
public class DESForJava_Hulunbuir {
	...
	private static byte[] asc_to_bcd(byte[] ascii, int asc_len) {
	...
	public static void main(String[] args) throws UnsupportedEncodingException {
		...
		byte[] encKey = DESForJava_Hulunbuir.keydes("12345678".getBytes(), "12345678".getBytes(), 8, 0);
		String encKeyS = new String(encKey);
		System.out.println(">>>"+encKeyS);
		byte[] decKey = DESForJava_Hulunbuir.keydes(encKeyS.getBytes(), "12345678".getBytes(), 8, 1);
		System.out.println(new String(decKey));
		
		String key = "12345678";
		String s="106081";
		byte[] b = DESForJava_Hulunbuir.encryption(s, key);
		byte[] c=bcd_to_asc(b);
		System.out.println(">>>>>ssss"+new String(c));
		int i = c.length;
		byte[] d=asc_to_bcd(c,i);
		String kk = DESForJava_Hulunbuir.decryption(d, key);
		...
		b = DESForJava_Hulunbuir.encryption(kkk, "1234567812345678");
		kk = DESForJava_Hulunbuir.decryption(b, "1234567812345678");
