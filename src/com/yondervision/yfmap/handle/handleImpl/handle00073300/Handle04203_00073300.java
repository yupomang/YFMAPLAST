...
public class Handle04203_00073300 implements CtrlHandleInter {
	Logger log = Logger.getLogger("YFMAP");
	@SuppressWarnings("rawtypes")
	public ModelMap action(AppApiCommonForm form1, ModelMap modelMap) throws CenterRuntimeException,Exception{
		String PROPERTIES_FILE_NAME = "properties.properties";
		AppApi030Form form = (AppApi030Form)form1;
		log.debug("00073300请求04203参数："+CommonUtil.getStringParams(form));
		...
		if(Constants.method_BSP.equals(send)){////xml通信处理
			...
			//String xml = MessageCtrMain.encapsulatedPackets(msgType, "E:/mcq/workspaceEclipse/YFMAP/src/com/yondervision/yfmap/config/messagetemp/00073300/BSP_REQ_GRJCZMDY.txt", map, req);
			...
			/*String rexml ="<AuthCode1>1</><AuthCode2>1</><AuthCode3>1</><AuthFlag>1</><BrcCode>1</><BusiSeq>1</><ChannelSeq>1</><ChkCode>1</><MTimeStamp>1</><NoteMsg>1</><RspCode>000000</><RspMsg>OK</><STimeStamp>1</><TellCode>1</><TranChannel>1</><TranCode>126991</><TranDate>1</><TranIP>1</><TranSeq>1</>"
				...
				+ "<trustdate>20161111</><zjlx>02</><dwmc>aaa</><dwjcbl>000</><clsaccint>222</><centerid>00073300</><cardno>1234567890</><cardbankcode>1010</><byearbal>1</><begpayym>2</><begintdate>3</><attworkdate>4</><agentop>5</><accinstcode>6</><accbankcode>7</>"
			...
			*/
			...
			//HashMap resultMap = MessageCtrMain.analysisPacket(msgType, "E:/mcq/workspaceEclipse/YFMAP/src/com/yondervision/yfmap/config/messagetemp/00073300/BSP_REP_GRJCZMDY.txt", rexml, req);
			...
			//String xml1 = MessageCtrMain.encapsulatedPackets(msgType, "E:/mcq/workspaceEclipse/YFMAP/src/com/yondervision/yfmap/config/messagetemp/00073300/BSP_REQ_GRJCZMDY1.txt", map1, req1);
			...
			//HashMap resultMap1 = MessageCtrMain.analysisPacket(msgType, "E:/mcq/workspaceEclipse/YFMAP/src/com/yondervision/yfmap/config/messagetemp/00073300/BSP_REP_GRJCZMDY1.txt", rexml1, req1);
	...
	/*public static void main(String[] args){
		...
		Handle04203_00073300 hand = new Handle04203_00073300();
		try {
