...
public class Handle3001_00075500 extends AbsBusinessServer {
	...
	public String acction(String xml, OutputStream out, String centerid, String seq)
		...
		log.debug("Handle3001_00085101:开始****处理短消息单笔推送逻辑");
		...
		if(Constants.method_XML.equals(send)){////xml通信处理
			...
			log.debug("Handle3001_00085101:acction封装移动平台JSON数据："+param);
...
//			sendXML(out, bResXML);
			...
			log.debug("Handle3001_00085101:YBMAP url ："+url);
		...
		log.debug("Handle3001_00085101:结束****处理短消息单笔推送逻辑");
		return remsg;
	}
