...
public class Handle00910_00073300 implements CtrlHandleInter {
	Logger log = Logger.getLogger("YFMAP");
	@SuppressWarnings("rawtypes")
	public ModelMap action(AppApiCommonForm form1, ModelMap modelMap) throws CenterRuntimeException,Exception{
		String PROPERTIES_FILE_NAME = "properties.properties";
		AppApi00910Form form = (AppApi00910Form)form1;
		log.debug("00073300请求00910参数："+CommonUtil.getStringParams(form));
	...
	/*public static void main(String[] args) throws Exception{
		...
		Handle00910_00073300 hand = new Handle00910_00073300();
		try {
