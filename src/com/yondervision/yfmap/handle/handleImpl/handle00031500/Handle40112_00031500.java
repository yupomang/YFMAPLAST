...
import com.yondervision.yfmap.result.tangshan.TangShanAppApi40112Result;
 ...
 * 请求验证码
 */
public class Handle40112_00031500 implements CtrlHandleInter {
	...
	public ModelMap action(AppApiCommonForm form1, ModelMap modelMap)
		...
		log.debug("form:"+form); 
		/* 模拟返回开始  */
		TangShanAppApi40112Result app01003Result= new TangShanAppApi40112Result();
		String req_xml = "REQ_SQYZM.xml";
		if(Constants.method_XML.equals(send)){
			...
			if(CommonUtil.isEmpty(form.getMobileNumber()))req_xml = "REQ_SQYZM01.xml";
...
//			}
			...
			String rexml = CommunicateUtil.sendMessage(send, ip, Integer.parseInt(port), xml, "X00000");
...
//			HashMap resultMap = MessageCtrMain.analysisPacket(msgType, "D:/server/apache-tomcat-6.0.44/webapps/ydmi_csp/WEB-INF/classes/com/yondervision/yfmap/config/messagetemp/00053100/REP_SQYZM.xml", rexml, req);
		...
		modelMap.put("msg", "成功");
		modelMap.put("transcode", app01003Result.getTransCode());
		modelMap.put("telphone", app01003Result.getTelphone());
	...
	public static void main(String[] args){
		...
		Handle40112_00031500 hand = new Handle40112_00031500();
		try {
