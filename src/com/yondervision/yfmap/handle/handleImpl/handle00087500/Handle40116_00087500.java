...
/** 
* @ClassName: Handle40116_00087500 
* @Description: 实名身份认证
* @date Mar 10, 2016 2:58:15 PM   
* 
*/ 
public class Handle40116_00087500 implements CtrlHandleInter {
	Logger log = Logger.getLogger("YFMAP");
	@SuppressWarnings("unchecked")
	public ModelMap action(AppApiCommonForm form1, ModelMap modelMap) throws CenterRuntimeException,Exception{
		log.info(Constants.LOG_HEAD+"appApi40116 start.");
		String PROPERTIES_FILE_NAME = "properties.properties";
		AppApi40115Form form = (AppApi40115Form)form1;
		log.debug("身份实名认证获取请求参"+form);
		...
		if(Constants.method_XML.equals(send)){////xml通信处理
			...
			form.setBuschktype("1122");
			// TODO
			System.out.println("idcardnum=="+form.getIdcardNumber());
			...
			System.out.println("bankaccnm=="+form.getCheckid());
			System.out.println("checkid=="+form.getCheckid());
			...
			log.debug("身份实名认证-前置YFMAP发往中心报文："+xml);	
			...
			log.debug("身份实名认证-前置YFMAP接收中心报文："+rexml);
