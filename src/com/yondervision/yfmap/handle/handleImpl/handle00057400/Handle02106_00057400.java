...
public class Handle02106_00057400 implements CtrlHandleInter {
	...
	public ModelMap action(AppApiCommonForm form1, ModelMap modelMap) throws CenterRuntimeException,Exception{
		...
		log.debug("00057400请求02106参数："+CommonUtil.getStringParams(form));
...
//				form.setBrcCode(PropertiesReader.getProperty(PROPERTIES_FILE_NAME, "appapi001BrcCode"+form.getCenterId()).trim());
			...
			String xml = MessageCtrMain.encapsulatedPackets(msgType, CommonUtil.getFullURL(Constants.msgPath+form.getCenterId())+"/BSP_REQ_TSXXCX.txt", map, req);
			//String xml = MessageCtrMain.encapsulatedPackets(msgType, "D:/workzone/YFMAP/src/com/yondervision/yfmap/config/messagetemp/00057400/BSP_REQ_TSXXCX.txt", map, req);
			log.debug("前置YFMAP发往中心报文："+xml);
			
			String ip = PropertiesReader.getProperty(PROPERTIES_FILE_NAME, "BSP_SOCKET_IP"+form.getCenterId()).trim();
			String port = PropertiesReader.getProperty(PROPERTIES_FILE_NAME, "BSP_SOCKET_PORT"+form.getCenterId()).trim();
			String rexml = CommunicateUtil.sendMessage(send, ip, Integer.parseInt(port), xml, "111412");
			
			//String rexml ="<AuthCode1>9711</><AuthCode2>9711</><AuthCode3>9711</><AuthFlag></><BrcCode>05740008</><BusiSeq>92629</><ChannelSeq>12357788</><ChkCode>9711</><MTimeStamp>2017-08-05 17:15:14:851000</><NoteMsg></><RspCode>000000</><RspMsg>交易处理成功...</><STimeStamp>2017-08-05 17:15:14:849000</><TellCode>9711</><TranChannel>00</><TranCode>111412</><TranDate>2017-08-11</><TranIP>172.16.8.100</><TranSeq>92629</><consum>4</><rsufilename>TSXXCX_010100000244_20170811</><rsufilepath>/bsptest/</>";
			
			log.debug("前置YFMAP接收中心报文——单位账户发生额明细批量查询下载："+rexml);
			resultMap = MessageCtrMain.analysisPacket(msgType, CommonUtil.getFullURL(Constants.msgPath+form.getCenterId())+"/BSP_REP_TSXXCX.txt", rexml, req);
			//resultMap = MessageCtrMain.analysisPacket(msgType, "D:/workzone/YFMAP/src/com/yondervision/yfmap/config/messagetemp/00057400/BSP_REP_TSXXCX.txt", rexml, req);
	...
	/*public static void main(String[] args){
		...
		form1.setChannel("40");
		form1.setBegdate("2017-01");
		form1.setEnddate("2017-07");
		form1.setIspaging("1");
		form1.setPagenum("1");
		form1.setPagerows("20");
		form1.setUnitaccnum("123");
		form1.setUnitacctype("2");
		form1.setTranstype("33");
		form1.setDptype("399");
		try{
		...
		Handle02106_00057400 hand = new Handle02106_00057400();
		try {
