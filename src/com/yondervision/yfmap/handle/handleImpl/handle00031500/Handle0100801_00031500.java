 ...
 * 变更登记查询-借款人通讯信息
 */
public class Handle0100801_00031500 implements CtrlHandleInter {
...
//				return modelMap;
//			}
			String xml = MessageCtrMain.encapsulatedPackets(msgType, CommonUtil.getFullURL(Constants.msgPath+form.getCenterId())+"REQ_BGDJCX01.xml", map, req);
...
//					"<certinum>4234141412</certinum>" +
//					"<bank>建行</bank>" +
//					"<loanflag>01</loanflag>" +
//					"<relphone>13432323277</relphone>" +
//					"<bankaccname>孙亚伟</bankaccname>" +
//					"<loannum>413432323277</loannum>" +
//					"<qyzt>02</qyzt>" +
//					"<tqlx>"+form.getDrawSignType()+"</tqlx>" +
//					"<bankcardno>62222222</bankcardno>" +
//					"</body></root>";

			
			log.debug("中心下传报文："+rexml);
			HashMap resultMap = MessageCtrMain.analysisPacket(msgType, CommonUtil.getFullURL(Constants.msgPath+form.getCenterId())+"REP_BGDJCX01.xml", rexml, req);
//			HashMap resultMap = MessageCtrMain.analysisPacket(msgType, "D:/server/apache-tomcat-6.0.44/webapps/ydmi_csp/WEB-INF/classes/com/yondervision/yfmap/config/messagetemp/00053100/REP_TQYYCX02.xml", rexml, req);
		...
		List<TitleInfoBean> appapi01008Result = JavaBeanUtil.javaBeanToListTitleInfoBean("appapi0100801"+form.getCenterId()+".result", app01006Result);
	...
	public static void main(String[] args){
		...
		Handle0100801_00031500 hand = new Handle0100801_00031500();
		try {
