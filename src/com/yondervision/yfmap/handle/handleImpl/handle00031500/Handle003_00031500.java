...
public class Handle003_00031500 implements CtrlHandleInter {
...
//			HashMap resultMap = MessageCtrMain.analysisPacket(msgType, "C:/Program Files/Tomcat 6.0/webapps/YFMAP/WEB-INF/classes/com/yondervision/yfmap/config/messagetemp/00053100/REP_JXDZCX.xml", rexml, req);
			...
			if(!Constants.sucess_ts.equals(appApi00301Result.getRecode())){
		...
		appApi00301Result.setIncramt(String.format("%.1f",Double.valueOf(appApi00301Result.getIncramt()))+"%");
		appApi00301Result.setDrawamt(String.format("%.1f",Double.valueOf(appApi00301Result.getDrawamt()))+"%");
		appApi00301Result.setIntamt(String.format("%.2f",Double.valueOf(appApi00301Result.getIntamt()))+"元");
		appApi00301Result.setBal(String.format("%.2f",Double.valueOf(appApi00301Result.getBal()))+"元");
		appApi00301Result.setKeepamt(String.format("%.2f",Double.valueOf(appApi00301Result.getKeepamt()))+"元");
...
//		modelMap.put("remark", appApi00301Result.getTips());
	...
	public static void main(String[] args){
		...
		form1.setLogid("113");
		Handle003_00031500 hand = new Handle003_00031500();
		try {
