...
@Controller
public class Webapi820Contorller {
     ...
     * @throws Exception
     */
    @RequestMapping("/webapi80020.{ext}")
    public String webapi80020(AppApi80016Form form, ModelMap modelMap, HttpServletRequest request, HttpServletResponse response) throws Exception {
        log.info(Constants.LOG_HEAD+"webapi80020 begin.");
