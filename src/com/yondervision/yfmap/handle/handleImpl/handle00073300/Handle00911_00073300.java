...
public class Handle00911_00073300 implements CtrlHandleInter {
	...
	public ModelMap action(AppApiCommonForm form1, ModelMap modelMap)
		...
		log.debug("00073300请求00911参数："+CommonUtil.getStringParams(form));
		...
		if(Constants.method_BSP.equals(send)){
			...
			//String xml = MessageCtrMain.encapsulatedPackets(msgType, "E:/mcq/workspaceEclipse/YFMAP/src/com/yondervision/yfmap/config/messagetemp/00073300/BSP_REQ_FWLXCX.txt", map, req);
			...
			//resultMap = MessageCtrMain.analysisPacket(msgType, "E:/mcq/workspaceEclipse/YFMAP/src/com/yondervision/yfmap/config/messagetemp/00073300/BSP_REP_FWLXCX.txt", rexml, req);
	...
	/*public static void main(String[] args){
		...
		form1.setChannel("40");
		Handle00911_00073300 hand = new Handle00911_00073300();
		try {
