...
//			String xml = MessageCtrMain.encapsulatedPackets(msgType, "D:/java/apache-tomcat-7.0.8-windows-x64/apache-tomcat-7.0.8/webapps/ydmi_csp/WEB-INF/classes/com/yondervision/yfmap/config/messagetemp/00087100/BSP_REQ_TXTQ.txt", map, req);
...
//		    HashMap resultMap = MessageCtrMain.analysisPacket(msgType, "D:/java/apache-tomcat-7.0.8-windows-x64/apache-tomcat-7.0.8/webapps/ydmi_csp/WEB-INF/classes/com/yondervision/yfmap/config/messagetemp/00087100/BSP_REP_TXTQ.txt", rexml, req);
		...
		modelMap.put("acc_flag", app03401ZHResult.getAcc_flag());
		modelMap.put("acc_amt", app03401ZHResult.getAcc_amt());
		log.info("【资金类业务03401】---退休提取----【start】");
		return modelMap;
	}
