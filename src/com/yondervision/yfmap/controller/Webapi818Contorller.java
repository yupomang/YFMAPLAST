...
@Controller
public class Webapi818Contorller {
     ...
     * @throws Exception
     */
    @RequestMapping("/webapi80018.{ext}")
    public String webapi80018(AppApi80016Form form, ModelMap modelMap, HttpServletRequest request, HttpServletResponse response) throws Exception {
        log.info(Constants.LOG_HEAD+"webapi80018 begin.");
