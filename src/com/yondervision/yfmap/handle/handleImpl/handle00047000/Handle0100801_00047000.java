...
/** 
* @ClassName: Handle0100801_00047000 
* @Description: 个人资料变更
* 
*/ 
public class Handle0100801_00047000 implements CtrlHandleInter {
	Logger log = Logger.getLogger("YFMAP");
	public ModelMap action(AppApiCommonForm form1, ModelMap modelMap) throws CenterRuntimeException,Exception{
		log.info(Constants.LOG_HEAD+"appApi0100801 start.");
		...
		HulunbuirAppApi0100801Result app40101Result = new HulunbuirAppApi0100801Result();
		if(Constants.method_BSP.equals(send)){////xml通信处理
			...
			String rexml = CommunicateUtil.sendMessage(send, ip, Integer.parseInt(port), xml, "167034");
...
//			String rexml = "<AuthCode1>cweb</><AuthCode2>cweb</><AuthCode3>cweb</><AuthFlag>0</><BrcCode>12345678</><BusiSeq>1269</><ChannelSeq>398243</><ChkCode>cweb</><MTimeStamp>2016-08-10 05:04:09</><NoteMsg></><RspCode>000000</><RspMsg>交易处理成功...</><STimeStamp>2016-08-10 05:04:09</><TellCode>cweb</><TranChannel>00</><TranCode>112813</><TranDate>2016-08-10</><TranIP>192.168.10.20</><TranSeq>1269</><accname>刘文龙</><accname1>正常</><accnum>801003368857</><bal>10366.79</><basenum>2145.60</><certinum>220122199107225011</><indipayamt>257.47</><indipaysum>514.94</><indiprop>0.120</><lasttransdate>2016-07-01</><lpaym>201604</><opnaccdate>2014-07-01</><unitaccname>乌兰察布电业局</><unitaccnum>01030032</><unitpayamt>257.47</><unitprop>0.120</>";
		...
		String certitype = app40101Result.getCertitype();
		String certitypeDesc = "";
		if("1".equals(app40101Result.getCertitype())){
			certitypeDesc = "身份证";
		}else if("2".equals(app40101Result.getCertitype())){
			certitypeDesc = "军官证";
		}else if("3".equals(app40101Result.getCertitype())){
			certitypeDesc = "护照";
		}else if("9".equals(app40101Result.getCertitype())){
			certitypeDesc = "其他";
		}else if("4".equals(app40101Result.getCertitype())){
			certitypeDesc = "外国人永久居留证";
		}
		app40101Result.setCertitype(certitypeDesc);
		...
		//handset,phone,marstatus,occupation,headship,eduexp,famaddr,fammonthinc
		modelMap.put("handset", app40101Result.getHandset());
		modelMap.put("phone", app40101Result.getPhone());
		modelMap.put("marstatus", app40101Result.getMarstatus());
		modelMap.put("occupation", app40101Result.getOccupation());
		modelMap.put("headship", app40101Result.getHeadship());
		modelMap.put("eduexp", app40101Result.getEduexp());
		modelMap.put("famaddr", app40101Result.getFamaddr());
		modelMap.put("pubcustid", app40101Result.getPubcustid());
		modelMap.put("fammonthinc", app40101Result.getFammonthinc());
		modelMap.put("certitype", certitype);
		modelMap.put("sex", app40101Result.getSex());
		modelMap.put("birthday", app40101Result.getBirthday());
		modelMap.put("msgflag", app40101Result.getMsgflag());
		modelMap.put("opnaccdate", app40101Result.getOpnaccdate());
		modelMap.put("techpost", app40101Result.getTechpost());
		modelMap.put("attworkdate", app40101Result.getAttworkdate());
		log.info(Constants.LOG_HEAD+"appApi0100802 end.");
		return modelMap;
	}
