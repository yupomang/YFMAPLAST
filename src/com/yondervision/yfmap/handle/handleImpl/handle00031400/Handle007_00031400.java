...
public class Handle007_00031400 implements CtrlHandleInter {
	...
	public ModelMap action(AppApiCommonForm form1, ModelMap modelMap)
		...
		List<ChengDeAppApi007Result> list = new ArrayList<ChengDeAppApi007Result>();
		...
		ChengDeAppApi00701Result app007Result = new ChengDeAppApi00701Result();
...
//					"<zjls>1</zjls>" +
//					"<zys>10</zys>" +
//					"<hkze>200000.000</hkze>" +
//					"<yhbjhj>50000.00</yhbjhj>" +
//					"<yhlxhj>20000.00</yhlxhj>" +
//					"<syqs>180</syqs>" +
//					"<detail><ywrq>2016-01-01</ywrq>" +
//					"<ywlx>缴存</ywlx>" +
//					"<bjje>2000.00</bjje>" +
//					"<lxje>0.00</lxje>" +
//					"<fxje>0.00</fxje>" +
//					"</detail><detail>" +
//					"<ywrq>2016-02-01</ywrq>" +
//					"<ywlx>缴存</ywlx>" +
//					"<bjje>2000.00</bjje>" +
//					"<lxje>0.00</lxje>" +
//					"<fxje>0.00</fxje>" +
//					"</detail><detail>" +
//					"<ywrq>2016-03-01</ywrq>" +
//					"<ywlx>缴存</ywlx>" +
//					"<bjje>2000.00</bjje>" +
//					"<lxje>0.00</lxje>" +
//					"<fxje>0.00</fxje>" +
...
//			log.debug("解析报文MAP："+resultMap);
			...
			if(filename!=null){
				...
				while (line != null) {// 判断读取到的字符串是否不为空
					ChengDeAppApi007Result aa00701Result = new ChengDeAppApi007Result();
					try {
...
//		app007Result.setFreeuse3(String.format("%,.2f",Double.valueOf(app007Result.getFreeuse3())));
		...
		for(int i=0;i<list.size();i++){
			...
			result1 = JavaBeanUtil.javaBeanToListTitleInfoBean("appapi00701"+form.getCenterId()+".result", (ChengDeAppApi007Result)list.get(i));	
			detail.add(result1);
		}
		
		List<TitleInfoBean> appapi007Result = JavaBeanUtil.javaBeanToListTitleInfoBean("appapi00701"+form.getCenterId()+".detail", app007Result);
...
//		modelMap.put("result", appapi00701Result);
		...
		modelMap.put("detail", appapi007Result);	
...
//		modelMap.put("enddate", app007Result.getEnddate());	
	...
	public static void main(String[] args){
		...
		Handle007_00031400 hand = new Handle007_00031400();
		try {
