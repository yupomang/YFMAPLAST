 ...
 *
 */
public class HulunbuirAppApi40112Result {
	/** 个人账号*/						
	...
	/** 个人月缴额 */						
	private String peryje = "";						
	/** 单位月缴额 */						
	private String unityje = "";
	/**
	 * 交易代码
	 */
	...
	public String getPrehapdate() {
		return prehapdate;
	}
	public void setPrehapdate(String prehapdate) {
		this.prehapdate = prehapdate;
	}
	...
	public String getPeryje() {
		return peryje;
	}
	public void setPeryje(String peryje) {
		this.peryje = peryje;
	}
	public String getUnityje() {
		return unityje;
	}
	public void setUnityje(String unityje) {
		this.unityje = unityje;
	}
