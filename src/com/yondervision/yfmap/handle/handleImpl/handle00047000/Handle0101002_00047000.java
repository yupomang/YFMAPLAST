...
/** 
* @ClassName: Handle0101002_00047000 
* @Description: 短信签约-贷款
* 
*/ 
public class Handle0101002_00047000 implements CtrlHandleInter {
	...
	public ModelMap action(AppApiCommonForm form1, ModelMap modelMap) throws CenterRuntimeException,Exception{
		...
		if(Constants.method_BSP.equals(send)){////xml通信处理
			...
			String rexml = CommunicateUtil.sendMessage(send, ip, Integer.parseInt(port), xml, "142812");
