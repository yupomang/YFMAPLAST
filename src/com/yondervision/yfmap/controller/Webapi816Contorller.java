...
public class Webapi816Contorller {
    ...
    public String webapi80016(AppApi80016Form form, ModelMap modelMap, HttpServletRequest request, HttpServletResponse response) throws Exception {
        log.info(Constants.LOG_HEAD+"webapi80016 begin.");
        log.info(form.getYear1());
        log.debug("form:"+form);
        log.info("modelMap"+modelMap);
        log.info("year1====="+request.getParameter("year1")+"+++++++++++++"+request.getAttribute("year1"));
