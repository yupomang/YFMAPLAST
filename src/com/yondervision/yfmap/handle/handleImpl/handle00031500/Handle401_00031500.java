...
public class Handle401_00031500 implements CtrlHandleInter {
...
//		form.setNewpassword(aes.decrypt(form.getNewpassword()));
		...
		TangShanAppApi40101Result app40101Result = new TangShanAppApi40101Result();//
...
//		check.YzCheck(form1, modelMap, "appapi40102");
	...
	public static void main(String[] args) throws CenterRuntimeException, Exception{
		...
		Handle401_00031500 hand = new Handle401_00031500();
