 ...
 * 个人通讯信息变更信息查询
 */
public class Handle40126_00031500 implements CtrlHandleInter {
	...
	public ModelMap action(AppApiCommonForm form1, ModelMap modelMap)
		...
		log.debug("个人通讯信息变更信息查询form:"+form); 
		...
		String req_xml = "REQ_GRTXXXBGCX.xml";
		if(Constants.method_XML.equals(send)){
			...
			log.debug("个人通讯信息变更信息查询发往中心报文："+xml);
			...
			log.debug("个人通讯信息变更信息查询中心下传报文："+rexml);
			HashMap resultMap = MessageCtrMain.analysisPacket(msgType, CommonUtil.getFullURL(Constants.msgPath+form.getCenterId())+"REP_GRTXXXBGCX.xml", rexml, req);
			System.out.println("个人通讯信息变更信息查询解析报文MAP："+resultMap);			
			...
			if(!Constants.sucess_ts.equals(app40126Result.getRecode())){
				...
				log.error("个人通讯信息变更信息查询中心返回报文 状态recode :"+app40126Result.getRecode()+"  ,  描述msg : "+app40126Result.getMsg());
				return modelMap;
			}
		}		
		...
		modelMap.put("msg", "成功");
		modelMap.put("phone", app40126Result.getSjh());
		return modelMap;
	}
	...
	public static void main(String[] args){
		...
		Handle40126_00031500 hand = new Handle40126_00031500();
		try {
