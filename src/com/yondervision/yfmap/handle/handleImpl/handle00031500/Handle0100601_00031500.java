 ...
 * 提取信息查询-销户提取
 */
public class Handle0100601_00031500 implements CtrlHandleInter {
	...
	public ModelMap action(AppApiCommonForm form1, ModelMap modelMap)
		...
		log.debug("form:"+form); 
		/* 模拟返回开始  */
		TangShanAppApi01006Result app01006Result= new TangShanAppApi01006Result();
...
//				return modelMap;
//			}
			String xml = MessageCtrMain.encapsulatedPackets(msgType, CommonUtil.getFullURL(Constants.msgPath+form.getCenterId())+"REQ_TQQYCX01.xml", map, req);
...
//			String rexml = "<?xml version=\"1.0\" encoding = \"UTF-8\"?><root><head><reqflag>1</reqflag><msgtype>75</msgtype><tr_code>X00005</tr_code><corp_no>00053100</corp_no><oreq_no>8020150929007169</oreq_no><tr_acdt>2015-09-29</tr_acdt><tr_time>10:25:15</tr_time><ans_code>000000</ans_code><ans_info>交易成功完成</ans_info><particular_code>000000</particular_code><particular_info>交易成功完成</particular_info><reserved></reserved></head><body><xm>夏洛</xm><zjlx>身份证</zjlx><zjhm>220001197701011234</zjhm><gfdz>梧桐花园88号</gfdz><dkje>500000.00</dkje><nx>30</nx><hkfs>等额本金</hkfs><dkye>400000.00</dkye><zkyh>建行</zkyh><yhhkzh>2012748300917887</yhhkzh><htdqrq>2025-12-31</htdqrq><cqzbz>未入库</cqzbz><czrq>2015-01-01</czrq></body></root>";
			...
			HashMap resultMap = MessageCtrMain.analysisPacket(msgType, CommonUtil.getFullURL(Constants.msgPath+form.getCenterId())+"REP_TQQYCX01.xml", rexml, req);
//			HashMap resultMap = MessageCtrMain.analysisPacket(msgType, "D:/server/apache-tomcat-6.0.44/webapps/ydmi_csp/WEB-INF/classes/com/yondervision/yfmap/config/messagetemp/00053100/REP_TQYYCX02.xml", rexml, req);
		...
		double tqje = Double.valueOf(app01006Result.getYe())+Double.valueOf(app01006Result.getLx());
		app01006Result.setYe(String.format("%.2f",Double.valueOf(app01006Result.getYe()))+"元");
		app01006Result.setLx(String.format("%.2f",Double.valueOf(app01006Result.getLx()))+"元");
		app01006Result.setTqje(String.format("%.2f",tqje)+"元");
		...
		List<TitleInfoBean> c_appapi01006Result = JavaBeanUtil.javaBeanToListTitleInfoBean("appapi0100601"+form.getCenterId()+".c_result", app01006Result);
		List<TitleInfoBean> m_appapi01006Result = JavaBeanUtil.javaBeanToListTitleInfoBean("appapi0100601"+form.getCenterId()+".m_result", app01006Result);
		List<TitleInfoBean> p_appapi01006Result = JavaBeanUtil.javaBeanToListTitleInfoBean("appapi0100601"+form.getCenterId()+".p_result", app01006Result);
		
		modelMap.clear();
		modelMap.put("recode", "000000");
		modelMap.put("msg", "成功");
		modelMap.put("c_result", c_appapi01006Result);
	...
	public static void main(String[] args){
		...
		Handle0100601_00031500 hand = new Handle0100601_00031500();
		try {
