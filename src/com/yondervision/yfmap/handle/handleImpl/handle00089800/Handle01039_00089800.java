 ...
 *
 */
public class Handle01039_00089800 implements CtrlHandleInter {
	...
	public ModelMap action(AppApiCommonForm form1, ModelMap modelMap) throws CenterRuntimeException,Exception{
		...
		AppApi01036Result app01039Result = new AppApi01036Result();
		...
		if(Constants.method_BSP.equals(send)){
			...
			BeanUtil.transMap2Bean(mapPool, app01039Result);
		}
		app01039Result.setDkhkfs(PropertiesReader.getProperty("yingshe.properties","dkhkfs"+app01039Result.getDkhkfs()+form.getCenterId()));
		List<TitleInfoBean> appapi00101Result = null;
		appapi00101Result = JavaBeanUtil.javaBeanToListTitleInfoBean("appapi01039"+form.getCenterId()+".result", app01039Result);
		...
		if(!CommonUtil.isEmpty(form.getApplyid()))
		{
			...
			modelMap.put("enddate", app01039Result.getEnddate());
			//modelMap.put("dkqs", app01039Result.getDkqs());
			//剩余未还期数
			modelMap.put("dkqs", app01039Result.getRemainterms());
