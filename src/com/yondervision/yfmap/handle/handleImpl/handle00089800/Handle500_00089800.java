 ...
 * 绑定
 */
public class Handle500_00089800 implements CtrlHandleInter {
	...
	public ModelMap action(AppApiCommonForm form1, ModelMap modelMap)
		...
		log.info(Constants.LOG_HEAD+"appApi500 start.");
		log.debug("form:"+form); 
		/* 模拟返回开始  */
		...
		if(Constants.method_BSP.equals(send)){
			...
			if(app40109Result.getCertinum()!=null)
		...
		modelMap.put("cardno", app40109Result.getCardno());	// 联名卡号
		modelMap.put("grzh", app40109Result.getAccnum());	//
		modelMap.put("psword", form.getPassword());	// 
		log.info(Constants.LOG_HEAD+"appApi500 end.");
		return modelMap;
	}
