...
public class Handle00126_00057400 implements CtrlHandleInter {
	Logger log = Logger.getLogger("YFMAP");
	public ModelMap action(AppApiCommonForm form1, ModelMap modelMap) throws CenterRuntimeException,Exception{
		String PROPERTIES_FILE_NAME = "properties.properties";
		AppApi030Form form = (AppApi030Form)form1;
		log.debug("00057400请求00126参数："+CommonUtil.getStringParams(form));
...
//				form.setBrcCode(PropertiesReader.getProperty(PROPERTIES_FILE_NAME, "appapi001BrcCode"+form.getCenterId()).trim());
			...
			String xml = MessageCtrMain.encapsulatedPackets(msgType, CommonUtil.getFullURL(Constants.msgPath+form.getCenterId())+"/BSP_REQ_SDKTQJEJS.txt", map, req);
			//String xml = MessageCtrMain.encapsulatedPackets(msgType, "D:/workzone/YFMAP/src/com/yondervision/yfmap/config/messagetemp/00057400/BSP_REQ_SDKTQJEJS.txt", map, req);
			log.debug("前置YFMAP发往中心报文："+xml);
			
			String ip = PropertiesReader.getProperty(PROPERTIES_FILE_NAME, "BSP_SOCKET_IP"+form.getCenterId()).trim();
			String port = PropertiesReader.getProperty(PROPERTIES_FILE_NAME, "BSP_SOCKET_PORT"+form.getCenterId()).trim();
			String rexml = CommunicateUtil.sendMessage(send, ip, Integer.parseInt(port), xml, "154007");
			...
			log.debug("前置YFMAP接收中心报文——商贷提取金额计算："+rexml);
			HashMap resultMap = MessageCtrMain.analysisPacket(msgType, CommonUtil.getFullURL(Constants.msgPath+form.getCenterId())+"/BSP_REP_SDKTQJEJS.txt", rexml, req);
			//HashMap resultMap = MessageCtrMain.analysisPacket(msgType, "D:/workzone/YFMAP/src/com/yondervision/yfmap/config/messagetemp/00057400/BSP_REP_SDKTQJEJS.txt", rexml, req);
			...
			if(!"0".equals(app00126ZHResult.getRecode())){
				...
				obj.put("errCode", app00126ZHResult.getRecode());
				obj.put("msg",  "错误信息："+app00126ZHResult.getMsg());
				result.add(obj);
		...
		modelMap.put("msg", "成功");			
		modelMap.put("buyhouseamt", app00126ZHResult.getBuyhouseamt());
		modelMap.put("buyhousedate", app00126ZHResult.getBuyhousedate());
		modelMap.put("cleardate", app00126ZHResult.getCleardate());
		modelMap.put("contrsigndate", app00126ZHResult.getContrsigndate());
		modelMap.put("houseaddr", app00126ZHResult.getHouseaddr());
		modelMap.put("lasttrsdate", app00126ZHResult.getLasttrsdate());
		modelMap.put("commloansum", app00126ZHResult.getCommloansum());
		modelMap.put("loanterm", app00126ZHResult.getLoanterm());
		modelMap.put("realdpayamt", app00126ZHResult.getRealdpayamt());
		modelMap.put("repaylntype", app00126ZHResult.getRepaylntype());
		modelMap.put("begdate", app00126ZHResult.getBegdate());
		modelMap.put("enddate", app00126ZHResult.getEnddate());
		modelMap.put("commonthrepayamt", app00126ZHResult.getCommonthrepayamt());
		return modelMap;
	}
