...
public class Handle02003_00073300 implements CtrlHandleInter1{
	...
	public ModelMap action(AppApiCommonForm form1, ModelMap modelMap, HttpServletRequest request, HttpServletResponse response) throws CenterRuntimeException, Exception {
		...
		log.debug("00073300请求02003参数："+CommonUtil.getStringParams(form));
	...
	/*public static void main(String[] args){
		...
		Handle02003_00073300 hand = new Handle02003_00073300();
		try {
