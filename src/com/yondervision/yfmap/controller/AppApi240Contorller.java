...
public class AppApi240Contorller {
	...
	public String appapi00241(AppApi030Form form, ModelMap modelMap,HttpServletRequest request, HttpServletResponse response) throws Exception{
		...
		log.debug("form:"+form);		
		CtrlHandleInter business = (CtrlHandleInter) Class.forName("com.yondervision.yfmap.handle.handleImpl.handle"+form.getCenterId()+".Handle00241_"+form.getCenterId()).newInstance();
		business.action(form, modelMap);	
	...
	public String appapi00242(AppApi030Form form, ModelMap modelMap,HttpServletRequest request, HttpServletResponse response) throws Exception{
		...
		log.debug("form:"+form);		
		CtrlHandleInter business = (CtrlHandleInter) Class.forName("com.yondervision.yfmap.handle.handleImpl.handle"+form.getCenterId()+".Handle000242_"+form.getCenterId()).newInstance();
		business.action(form, modelMap);	
	...
	public String appapi00243(AppApi030Form form, ModelMap modelMap,HttpServletRequest request, HttpServletResponse response) throws Exception{
		...
		log.debug("form:"+form);		
		CtrlHandleInter business = (CtrlHandleInter) Class.forName("com.yondervision.yfmap.handle.handleImpl.handle"+form.getCenterId()+".Handle00243_"+form.getCenterId()).newInstance();
		business.action(form, modelMap);	
	...
	public String appapi00244(AppApi030Form form, ModelMap modelMap,HttpServletRequest request, HttpServletResponse response) throws Exception{
		...
		log.debug("form:"+form);		
		CtrlHandleInter business = (CtrlHandleInter) Class.forName("com.yondervision.yfmap.handle.handleImpl.handle"+form.getCenterId()+".Handle00244_"+form.getCenterId()).newInstance();
		business.action(form, modelMap);	
	...
	public String appapi00245(AppApi030Form form, ModelMap modelMap,HttpServletRequest request, HttpServletResponse response) throws Exception{
		...
		log.debug("form:"+form);
		CtrlHandleInter business = (CtrlHandleInter) Class.forName("com.yondervision.yfmap.handle.handleImpl.handle"+form.getCenterId()+".Handle00245_"+form.getCenterId()).newInstance();
		business.action(form, modelMap);
