 ...
 * 余额明细查询
 */
public class Handle002_00031400 implements CtrlHandleInter {
	...
	public ModelMap action(AppApiCommonForm form1, ModelMap modelMap)
		...
		List<ChengDeAppApi00201Result> list = new ArrayList<ChengDeAppApi00201Result>();
		...
		ChengDeAppApi00201Result app002Result = new ChengDeAppApi00201Result();
...
//			HashMap resultMap = MessageCtrMain.analysisPacket(msgType, "C:/Program Files/Tomcat 6.0/webapps/YFMAP/WEB-INF/classes/com/yondervision/yfmap/config/messagetemp/00053100/REP_YEMXCX.xml", rexml, req);
			...
			if(filename!=null){
				...
				while (line != null) {// 判断读取到的字符串是否不为空
					ChengDeAppApi00201Result aa00201Result = new ChengDeAppApi00201Result();
					try {
						String[] valus = line.split("\\@\\|\\$");
						log.debug("读取文件  ："+line);
						aa00201Result.setOperationDate(valus[0]);
						aa00201Result.setOperationMemo(valus[1]+"-"+valus[4]);
	...
	public static void main(String[] args){
		...
		Handle002_00031400 hand = new Handle002_00031400();
		try {
