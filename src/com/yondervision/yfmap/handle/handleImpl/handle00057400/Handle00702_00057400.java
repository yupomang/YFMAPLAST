...
import com.yondervision.yfmap.result.ningbo.AppApi00702ZHResult;
...
public class Handle00702_00057400 implements CtrlHandleInter {
	...
	public ModelMap action(AppApiCommonForm form1, ModelMap modelMap)
		...
		log.debug("00057400请求00702参数："+CommonUtil.getStringParams(form));
...
//				form.setBrcCode(PropertiesReader.getProperty(PROPERTIES_FILE_NAME, "appapi002BrcCode"+form.getCenterId()).trim());
			...
			String xml = MessageCtrMain.encapsulatedPackets(msgType, CommonUtil.getFullURL(Constants.msgPath+form.getCenterId())+"/BSP_REQ_DKYEXXCX.txt", map, req);
			//String xml = MessageCtrMain.encapsulatedPackets(msgType, "E:/mcq/workspaceEclipse/YFMAP/src/com/yondervision/yfmap/config/messagetemp/00057400/BSP_REQ_DKYEXXCX.txt", map, req);
			log.debug("前置YFMAP发往中心报文："+xml);			
			String ip = PropertiesReader.getProperty(PROPERTIES_FILE_NAME, "BSP_SOCKET_IP"+form.getCenterId()).trim();
			String port = PropertiesReader.getProperty(PROPERTIES_FILE_NAME, "BSP_SOCKET_PORT"+form.getCenterId()).trim();
			String rexml = CommunicateUtil.sendMessage(send, ip, Integer.parseInt(port), xml, "142817");
			...
			//	+ "<amt>500.00</><houseaddr>asdfghj</><loanbal>1000</><loaneename>aaaaa</><loanterm>200</><monthrepayamt>100</><oweint>111</><oweprin>222</><term>10</>";
			log.debug("前置YFMAP接收中心报文："+rexml);
			resultMap = MessageCtrMain.analysisPacket(msgType, CommonUtil.getFullURL(Constants.msgPath+form.getCenterId())+"/BSP_REP_DKYEXXCX.txt", rexml, req);
			//resultMap = MessageCtrMain.analysisPacket(msgType, "E:/mcq/workspaceEclipse/YFMAP/src/com/yondervision/yfmap/config/messagetemp/00057400/BSP_REP_DKYEXXCX.txt", rexml, req);
			...
			if(!"0".equals(app00702ZHResult.getRecode())){
				...
				modelMap.put("msg", "错误信息："+app00702ZHResult.getMsg());
	...
	/*public static void main(String[] args){
		...
		Handle00702_00057400 hand = new Handle00702_00057400();
		try {
