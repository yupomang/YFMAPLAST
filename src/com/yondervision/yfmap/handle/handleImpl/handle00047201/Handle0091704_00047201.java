...
/** 
* @ClassName: Handle0091704_00047201 
* @Description: 贷款额度试算——单身有共同借款人
* 
*/ 
public class Handle0091704_00047201 implements CtrlHandleInter {
	...
	public ModelMap action(AppApiCommonForm form1, ModelMap modelMap) throws CenterRuntimeException,Exception{
		...
		log.debug("贷款额度试算——单身有共同借款人请求参:"+form);
		...
		if(Constants.method_BSP.equals(send)){////xml通信处理
			...
			String rexml = CommunicateUtil.sendMessage(send, ip, Integer.parseInt(port), xml, "312444");
