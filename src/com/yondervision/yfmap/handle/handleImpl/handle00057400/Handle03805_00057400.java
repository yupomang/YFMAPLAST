...
public class Handle03805_00057400 implements CtrlHandleInter {
...
//				form.setBrcCode(PropertiesReader.getProperty(PROPERTIES_FILE_NAME, "appapi001BrcCode"+form.getCenterId()).trim());
		    ...
		    String xml = MessageCtrMain.encapsulatedPackets(msgType, CommonUtil.getFullURL(Constants.msgPath+form.getCenterId())+"/BSP_REQ_DWYW_WTNDYS.txt", map, req);
			//String xml = MessageCtrMain.encapsulatedPackets(msgType, "D:/workzone/YFMAP/src/com/yondervision/yfmap/config/messagetemp/00057400/BSP_REQ_DWYW_WTNDYS.txt", map, req);
			log.debug("前置YFMAP发往中心报文："+xml);			
			String ip = PropertiesReader.getProperty(PROPERTIES_FILE_NAME, "BSP_SOCKET_IP"+form.getCenterId()).trim();
			String port = PropertiesReader.getProperty(PROPERTIES_FILE_NAME, "BSP_SOCKET_PORT"+form.getCenterId()).trim();
			String rexml = CommunicateUtil.sendMessage(send, ip, Integer.parseInt(port), xml, "191299");
			
			//String rexml ="<AuthCode1>1994</><AuthCode2>1994</><AuthCode3>1994</><AuthFlag></><BrcCode>05740008</><BusiSeq>95547</><ChannelSeq>12364421</><ChkCode>1994</><MTimeStamp>2017-08-23 19:21:14:812000</><NoteMsg></><RspCode>000000</><RspMsg>交易处理成功...</><STimeStamp>2017-08-23 19:21:14:811000</><TellCode>1994</><TranChannel>00</><TranCode>191299</><TranDate>2017-08-20</><TranIP>172.16.8.104</><TranSeq>95547</>";
			log.debug("前置YFMAP接收中心报文——网厅年度验审："+rexml);
		    HashMap resultMap = MessageCtrMain.analysisPacket(msgType, CommonUtil.getFullURL(Constants.msgPath+form.getCenterId())+"/BSP_REP_DWYW_WTNDYS.txt", rexml, req);
		    //HashMap resultMap = MessageCtrMain.analysisPacket(msgType, "D:/workzone/YFMAP/src/com/yondervision/yfmap/config/messagetemp/00057400/BSP_REP_DWYW_WTNDYS.txt", rexml, req);
		...
		modelMap.put("msg", "成功");
		modelMap.put("flag", app03804ZHResult.getFlag());
		return modelMap;
	}
...
/*	public static void main(String[] args){
		...
		Handle03805_00057400 hand = new Handle03805_00057400();
		try {
