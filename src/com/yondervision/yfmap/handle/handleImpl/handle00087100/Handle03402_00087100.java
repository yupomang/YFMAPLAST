...
public class Handle03402_00087100 implements CtrlHandleInter{

	Logger log = Logger.getLogger("YFMAP");
	public ModelMap action(AppApiCommonForm form1, ModelMap modelMap) throws CenterRuntimeException,Exception{
		String PROPERTIES_FILE_NAME = "properties.properties";
		AppApi03402Form form = (AppApi03402Form)form1;
		log.info("【资金类业务03402】---物业费提取----【start】");
		log.debug("form:"+form);
...
//			String xml = MessageCtrMain.encapsulatedPackets(msgType, "D:/java/apache-tomcat-7.0.8-windows-x64/apache-tomcat-7.0.8/webapps/ydmi_csp/WEB-INF/classes/com/yondervision/yfmap/config/messagetemp/00087100/BSP_REQ_WYFTQ.txt", map, req);
...
//			String rexml ="<AuthCode1></><AuthCode2>1</><AuthCode3>1</><AuthFlag>1</><BrcCode>1</><BusiSeq>1</><ChannelSeq>1</><ChkCode></><FinancialDate>1</><HostBank>1</><MTimeStamp></><NoteMsg>1</><RspCode>000000</><RspMsg>OK</><STimeStamp>1</><SubBank>1</><TellCode>1</><TranChannel>1</><TranCode>168061</><TranDate>1</><TranIP>1</><TranSeq>1</><accname>123</><certinum>45</><unitaccnum>45</><unitaccname>64</><balance>3443525</><hasgjjloan>1###存在</><peraccstate>0###已存</><transdate>546</><hostsernum>887</><bankcode>6###交通银行</><bankaccnum>57</><bankaccname>567</><usebalance>56789</>";
			...
			log.info("response 前置YFMAP接收中心报文——开发商保证金账户查询："+rexml);
...
//		    HashMap resultMap = MessageCtrMain.analysisPacket(msgType, "D:/java/apache-tomcat-7.0.8-windows-x64/apache-tomcat-7.0.8/webapps/ydmi_csp/WEB-INF/classes/com/yondervision/yfmap/config/messagetemp/00087100/BSP_REP_WYFTQ.txt", rexml, req);
		...
		modelMap.put("acc_flag", app03402ZHResult.getAcc_flag());
		modelMap.put("acc_amt", app03402ZHResult.getAcc_amt());
		log.info("【资金类业务03402】---物业费提取----【end】");
		return modelMap;
	}
}
