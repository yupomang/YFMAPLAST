...
public class Handle002_00047201 implements CtrlHandleInter {
	...
	public ModelMap action(AppApiCommonForm form1, ModelMap modelMap) throws CenterRuntimeException,Exception{
		...
		List<BaoGangAppApi00201Result> list = new ArrayList<BaoGangAppApi00201Result>();
		...
		BaoGangAppApi00201Result app002Result = new BaoGangAppApi00201Result();
		if(Constants.method_BSP.equals(send)){////xml通信处理
			...
			String reqxml = CommunicateUtil.sendMessage(send, ip, Integer.parseInt(port), xml, "310097");
...
//				}
				int i = 0;
				while (line != null) {
					BaoGangAppApi00201Result aa00201Result = new BaoGangAppApi00201Result();
					try {
...
//							if(sum>num){
							if(i!=0){
								...
								aa00201Result.setUnitaccnum(param[2].trim());						
								aa00201Result.setSummary(param[3].trim());	
								aa00201Result.setPaybegindate(param[4].trim());
								aa00201Result.setPayenddate(param[5].trim());						
								aa00201Result.setBusiamt(param[6].trim());	
								aa00201Result.setBalance(param[7].trim());
