...
public class Handle002_00047000 implements CtrlHandleInter {
	...
	public ModelMap action(AppApiCommonForm form1, ModelMap modelMap) throws CenterRuntimeException,Exception{
		...
		List<HulunbuirAppApi00201Result> list = new ArrayList<HulunbuirAppApi00201Result>();
...
//		form.setIdcardNumber(aes.decrypt(form.getIdcardNumber()));
		HulunbuirAppApi00201Result app002Result = new HulunbuirAppApi00201Result();
...
//				}
				while (line != null) {
					HulunbuirAppApi00201Result aa00201Result = new HulunbuirAppApi00201Result();
					try {
