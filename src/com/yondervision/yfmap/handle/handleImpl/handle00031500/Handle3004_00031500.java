...
public class Handle3004_00031500 extends AbsBusinessServer {
	...
	public String acction(String xml, OutputStream out, String centerid, String seq)
		...
		centerId = centerid;
		log.debug("Handle3004_00031500:开始****处理模板信息单笔推送逻辑");
...
//			resultMap.put("recvTime",appapi3004result.getSendSeqno());
			...
			try {
				...
				log.debug("Handle3004_00031500:acction返回报文："+remsg);
				System.out.println("Handle3004_00031500:acction返回报文："+remsg);
			} catch (IOException e) {				
				e.printStackTrace();
		...
		log.debug("Handle3004_00031500:结束****处理模板信息单笔推送逻辑");
		return remsg;
	}
	...
	private void sendUrl() {
		...
		log.debug("Handle3004_00031500:YBMAP url ："+url);
		System.out.println("Handle3004_00031500:YBMAP url ："+url);
		resultMap.put("centerId", centerId);
		String rm1 = post.post(url, resultMap);
		System.out.println("Handle3004_00031500:YBMAP 返回信息l ："+rm1);
		Gson gson1 = new Gson();
	...
	private void sendUrl1020() {
		...
		System.out.println("Handle3004_00031500:YBMAP url ："+url1);
		resultMap.put("centerId", centerId);
		...
		System.out.println("Handle3004_00031500:YBMAP 返回信息l ："+rm);
		Gson gson = new Gson();
