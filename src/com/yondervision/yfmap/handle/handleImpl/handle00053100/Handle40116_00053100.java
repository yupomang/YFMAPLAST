 ...
 * 实名认证
 */
public class Handle40116_00053100 implements CtrlHandleInter {
	...
	public ModelMap action(AppApiCommonForm form1, ModelMap modelMap)
		...
		log.debug("form:"+form); 
		/* 模拟返回开始  */
		JiNanAppApi40116Result app40116Result= new JiNanAppApi40116Result();
...
//				return modelMap;
//			}
			String xml = MessageCtrMain.encapsulatedPackets(msgType, CommonUtil.getFullURL(Constants.msgPath+form.getCenterId())+"REQ_GRRZ.xml", map, req);
//			String xml = MessageCtrMain.encapsulatedPackets(msgType, "D:/server/apache-tomcat-6.0.44/webapps/ydmi_csp/WEB-INF/classes/com/yondervision/yfmap/config/messagetemp/00053100/REQ_GRRZ.xml", map, req);
...
//			String rexml = "<?xml version=\"1.0\" encoding = \"UTF-8\"?><root><head><reqflag>1</reqflag><msgtype>82</msgtype><tr_code>X00012</tr_code><corp_no>00053100</corp_no>" +
//					"<oreq_no>8020150929007169</oreq_no>" +
//					"<tr_acdt>2016-05-17</tr_acdt>" +
//					"<tr_time>10:00:00</tr_time>" +
//					"<ans_code>000000</ans_code>" +
//					"<ans_info>认证成功</ans_info>" +
...
//					"</body></root>";
			...
			HashMap resultMap = MessageCtrMain.analysisPacket(msgType, CommonUtil.getFullURL(Constants.msgPath+form.getCenterId())+"REP_GRRZ.xml", rexml, req);
//			HashMap resultMap = MessageCtrMain.analysisPacket(msgType, "D:/server/apache-tomcat-6.0.44/webapps/ydmi_csp/WEB-INF/classes/com/yondervision/yfmap/config/messagetemp/00053100/REP_GRRZ.xml", rexml, req);
			log.debug("解析报文MAP："+resultMap);			
			BeanUtil.transMap2Bean(resultMap, app40116Result);
			
			
			if(!Constants.sucess.equals(app40116Result.getRecode())){
				modelMap.put("recode", app40116Result.getRecode());
				modelMap.put("msg", app40116Result.getMsg());
				log.error("中心返回报文 状态recode :"+app40116Result.getRecode()+"  ,  描述msg : "+app40116Result.getMsg());
				return modelMap;
			}
		}		
		...
		//List<TitleInfoBean> appapi40116Result = JavaBeanUtil.javaBeanToListTitleInfoBean("appapi40116"+form.getCenterId()+".result", app41201Result);
		modelMap.clear();
	...
	public static void main(String[] args){
		...
		Handle40116_00053100 hand = new Handle40116_00053100();
		try {
