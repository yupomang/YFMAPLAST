...
public class Handle3005_00047000 extends AbsBusinessServer {
	...
	public String acction(String xml, OutputStream out, String centerid, String seq)
		...
		log.debug("Handle3005_00047000:开始****处理短消息批量推送逻辑");
		log.debug("appapi3004Send"+centerid);
		...
		if(Constants.method_XML.equals(send)){////xml通信处理
			...
			HashMap resultMap;
			try {
				log.debug("Handle3005_00047000 接收报文: "+xml);
				...
				//resultMap = MessageCtrMain.analysisPacket(msgType, "D:/Workspaces_work/YFMAP/src/com/yondervision/yfmap/config/messagetemp/00053100/"+"REQ_HX_PL_MESSAGE_SEND.xml", xml, seq);
			} catch (Exception e) {
				e.printStackTrace();
...
//			    appapi3005result.setFilePath(filePath);
			...
			log.debug("Handle3005_00053100:YBMAP url ："+url);
			...
			try {
				...
				log.debug("Handle3005_00053100:acction返回报文："+remsg);
			} catch (IOException e) {				
				e.printStackTrace();
		...
		log.debug("Handle3005_00053100:结束****处理短消息批量推送逻辑");
		return remsg;
	}
	...
	public static void main(String[] args){
		String xml = "<?xml version=\"1.0\" encoding = \"UTF-8\"?><root>" +
				"<head><reqflag>0</reqflag><msgtype>94</msgtype><tr_code>X00014</tr_code> <corp_no>00053100</corp_no>  <user_no>8888</user_no> <req_no>2820150929007169</req_no> <oreq_no></oreq_no>  <tr_acdt>2016-05-23</tr_acdt> <tr_time>10:25:15</tr_time> <channel>28</channel>  <sign>28</sign>  <key></key> <reserved></reserved> </head>" +
				...
				"<sendType>111</sendType><timer>1</timer><chanel>10</chanel><title>1</title><detail>1</detail><theme>1</theme><sendDate1>1</sendDate1><sendTime1>1</sendTime1><centerId>00053100</centerId><freeuse1></freeuse1><freeuse2></freeuse2><freeuse3></freeuse3></body></root>";
		Handle3005_00047000 hand = new Handle3005_00047000();
		
		try {
			OutputStream out = null;
			hand.acction(xml,out,"00053100","");
