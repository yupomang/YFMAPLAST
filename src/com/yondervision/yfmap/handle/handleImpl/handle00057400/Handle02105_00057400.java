...
public class Handle02105_00057400 implements CtrlHandleInter {
	...
	public ModelMap action(AppApiCommonForm form1, ModelMap modelMap) throws CenterRuntimeException,Exception{
		...
		log.debug("00057400请求02104参数："+CommonUtil.getStringParams(form));
...
//				form.setBrcCode(PropertiesReader.getProperty(PROPERTIES_FILE_NAME, "appapi001BrcCode"+form.getCenterId()).trim());
			...
			String xml = MessageCtrMain.encapsulatedPackets(msgType, CommonUtil.getFullURL(Constants.msgPath+form.getCenterId())+"/BSP_REQ_KJGDRXXCX.txt", map, req);
			//String xml = MessageCtrMain.encapsulatedPackets(msgType, "D:/workzone/YFMAP/src/com/yondervision/yfmap/config/messagetemp/00057400/BSP_REQ_KJGDRXXCX.txt", map, req);
			log.debug("前置YFMAP发往中心报文："+xml);
			
			String ip = PropertiesReader.getProperty(PROPERTIES_FILE_NAME, "BSP_SOCKET_IP"+form.getCenterId()).trim();
			String port = PropertiesReader.getProperty(PROPERTIES_FILE_NAME, "BSP_SOCKET_PORT"+form.getCenterId()).trim();
			String rexml = CommunicateUtil.sendMessage(send, ip, Integer.parseInt(port), xml, "111404");
			
			//String rexml ="<AuthCode1>1200</><AuthCode2>1200</><AuthCode3>1200</><AuthFlag></><BrcCode>05740008</><BusiSeq>89669</><ChannelSeq>12351741</><ChkCode>1200</><MTimeStamp>2017-08-04 16:44:53:709000</><NoteMsg></><RspCode>000000</><RspMsg>交易处理成功...</><STimeStamp>2017-08-04 16:44:53:708000</><TellCode>1200</><TranChannel>00</><TranCode>111404</><TranDate>2017-08-10</><TranIP>172.16.5.100</><TranSeq>89669</><consum>3</><rsufilename>KJGDRCX_0042447149_20170810</><rsufilepath>/bsptest/00000000/fil/KJGDRCX_0042447149_20170810</>";
			
			log.debug("前置YFMAP接收中心报文——单位账户发生额明细批量查询下载："+rexml);
			resultMap = MessageCtrMain.analysisPacket(msgType, CommonUtil.getFullURL(Constants.msgPath+form.getCenterId())+"/BSP_REP_KJGDRXXCX.txt", rexml, req);
			//resultMap = MessageCtrMain.analysisPacket(msgType, "D:/workzone/YFMAP/src/com/yondervision/yfmap/config/messagetemp/00057400/BSP_REP_KJGDRXXCX.txt", rexml, req);
	...
	/*public static void main(String[] args){
		...
		Handle02105_00057400 hand = new Handle02105_00057400();
		try {
