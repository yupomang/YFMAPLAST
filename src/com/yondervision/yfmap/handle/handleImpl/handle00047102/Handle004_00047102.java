...
import com.yondervision.yfmap.result.qvzhi.QvZhiAppApi00401Result;
...
/** 
* @ClassName: Handle004_00047102
* @Description: 提取金额查询
* 
*/ 
public class Handle004_00047102 implements CtrlHandleInter {
	...
	public ModelMap action(AppApiCommonForm form1, ModelMap modelMap)
		...
		log.debug("form:"+form);		
		QvZhiAppApi00401Result appApi00401Result	= new QvZhiAppApi00401Result();
		if(Constants.method_BSP.equals(send)){////xml通信处理
			...
			String reqxml = CommunicateUtil.sendMessage(send, ip, Integer.parseInt(port), xml, "119020");
		...
		appApi00401Result.setYdrawamt(String.format("%,.2f",Double.valueOf(appApi00401Result.getYdrawamt())));
		appApi00401Result.setFreeuse2(String.format("%,.2f",Double.valueOf(appApi00401Result.getFreeuse2())));
