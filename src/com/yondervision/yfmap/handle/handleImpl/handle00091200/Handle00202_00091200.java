...
public class Handle00202_00091200 implements CtrlHandleInter {
	...
	public ModelMap action(AppApiCommonForm form1, ModelMap modelMap)
		...
		String zhmxTqServer = PropertiesReader.getProperty("properties.properties", "ZHMX_"+form.getCenterId()+"_TQ_SERVER");
		String zhmxHdServer = PropertiesReader.getProperty("properties.properties", "ZHMX_"+form.getCenterId()+"_HD_SERVER");
		...
		if(Constants.method_XML.equals(send)){////xml通信处理
			...
			if(!"00".equals(app00202Result.getRecode())){
