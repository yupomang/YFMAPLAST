...
* @Description: 遵义核心密码修改
* @author Caozhongyan
* @date Apr 14, 2016 2:58:15 PM   
* 
*/ 
public class Handle40114_00085200 implements CtrlHandleInter {
	...
	public ModelMap action(AppApiCommonForm form1, ModelMap modelMap) throws CenterRuntimeException,Exception{
		...
		byte[] b1 = DESForJava.encryption(form.getPassword(), "12345678");
		byte[] c1 = DESForJava.bcd_to_asc(b1);
		form.setPassword(new String(c1));
		
		byte[] b2 = DESForJava.encryption(form.getNewpassword(), "12345678");
		byte[] c2 = DESForJava.bcd_to_asc(b2);
