...
public class Handle005_00066800 implements CtrlHandleInter {
	...
	public ModelMap action(AppApiCommonForm form1, ModelMap modelMap)
		...
		log.debug("00066800请求00501参数："+CommonUtil.getStringParams(form));
...
//			String xml = MessageCtrMain.encapsulatedPackets(msgType, "D:/java/apache-tomcat-7.0.8-windows-x64/apache-tomcat-7.0.8/webapps/ydmi_csp/WEB-INF/classes/com/yondervision/yfmap/config/messagetemp/00073300/BSP_REQ_GRTQMXCX.txt", map, req);
...
//			String rexml ="<AuthCode1></><AuthCode2></><AuthCode3></><AuthFlag>0</><BrcCode>00073199</><BusiSeq>6840</><ChannelSeq>0</><ChkCode></><MTimeStamp>2017-01-15 09:27:33</><NoteMsg></><RspCode>000000</><RspMsg>交易处理成功...</><STimeStamp>2017-01-15 09:27:33</><TellCode>9999</><TranChannel>8</><TranCode>112306</><TranDate>2017-01-15</><TranIP></><TranSeq>6840</><filename>F:/bbb.txt</><totalnum>13</><totalpage>2</>> ";
...
//			resultMap = MessageCtrMain.analysisPacket(msgType, "D:/java/apache-tomcat-7.0.8-windows-x64/apache-tomcat-7.0.8/webapps/ydmi_csp/WEB-INF/classes/com/yondervision/yfmap/config/messagetemp/00073300/BSP_REP_GRTQMXCX.txt", rexml, req);
...
//				File file = new File(filename);//File(ReadProperties.getString("bsp_local_path")+form.getSendDate()+"/"+fname);
				...
				while (line1 != null) {// 判断读取到的字符串是否不为空
					...
					try {
						...
						app005_01ZHResult.setShroffnumer(Tools.getDesensitizationCertinum(trs[10]));
