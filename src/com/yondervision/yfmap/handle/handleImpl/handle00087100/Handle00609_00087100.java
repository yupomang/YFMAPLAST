...
public class Handle00609_00087100 implements CtrlHandleInter {
...
//				form.setBrcCode(PropertiesReader.getProperty(PROPERTIES_FILE_NAME, "appapi002BrcCode"+form.getCenterId()).trim());
			...
			String path = CommonUtil.getFullURL(Constants.msgPath+form.getCenterId());
			System.out.println("###################"+path);
			String xml = MessageCtrMain.encapsulatedPackets(msgType, path+"/BSP_REQ_TQBFHKSS.txt", map, req);
//			String xml = MessageCtrMain.encapsulatedPackets(msgType, "D:/java/apache-tomcat-7.0.8-windows-x64/apache-tomcat-7.0.8/webapps/ydmi_csp/WEB-INF/classes/com/yondervision/yfmap/config/messagetemp/00087100/BSP_REQ_TQBFHKSS.txt", map, req);
...
//			resultMap = MessageCtrMain.analysisPacket(msgType, "D:/java/apache-tomcat-7.0.8-windows-x64/apache-tomcat-7.0.8/webapps/ydmi_csp/WEB-INF/classes/com/yondervision/yfmap/config/messagetemp/00087100/BSP_REP_TQBFHKSS.txt", rexml, req);
