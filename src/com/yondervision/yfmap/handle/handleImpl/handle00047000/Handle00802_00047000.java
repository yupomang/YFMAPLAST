...
public class Handle00802_00047000 implements CtrlHandleInter {
	...
	public ModelMap action(AppApiCommonForm form1, ModelMap modelMap) throws CenterRuntimeException,Exception{
		...
		if(Constants.method_BSP.equals(send)){////xml通信处理
			...
			String reqxml = CommunicateUtil.sendMessage(send, ip, Integer.parseInt(port), xml, "129917");
...
//							if(sum>num){
								...
								log.debug("读取文件  ："+line);
								aa00201Result.setCocustname(param[0].trim());
								aa00201Result.setProjectname(param[1].trim());
								aa00201Result.setProtonum(param[3].trim());
