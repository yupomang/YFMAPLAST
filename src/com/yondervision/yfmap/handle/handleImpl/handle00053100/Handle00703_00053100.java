...
import com.yondervision.yfmap.result.jinan.JiNanAppApi00703Result;
import com.yondervision.yfmap.util.BeanUtil;
import com.yondervision.yfmap.util.CommonUtil;
import com.yondervision.yfmap.util.JavaBeanUtil;
import com.yondervision.yfmap.util.PropertiesReader;

public class Handle00703_00053100 implements CtrlHandleInter {
	...
	public ModelMap action(AppApiCommonForm form1, ModelMap modelMap)
		...
		List<JiNanAppApi00703Result> list = new ArrayList<JiNanAppApi00703Result>();
		if("".equals(form.getPagerows()))form.setPagerows("12");
		form.setPagerows(String.valueOf((Integer.valueOf(form.getPagerows())+1)));
		if("".equals(form.getStartdate()))
		{
			form.setStartdate(Calendar.getInstance().get(Calendar.YEAR)+"-01"+"-01");
		}
		if("".equals(form.getEnddate()))
		{
			form.setEnddate(Calendar.getInstance().get(Calendar.YEAR)+ "-12" + "-31");
		}
		log.debug("form:"+form);
...
//			String xml = MessageCtrMain.encapsulatedPackets(msgType, "D:/server/apache-tomcat-6.0.44/webapps/ydmi_csp/WEB-INF/classes/com/yondervision/yfmap/config/messagetemp/00053100/REQ_HKJHCX.xml", map, req);
			...
			String rexml = CommunicateUtil.sendMessage(send, ip, Integer.parseInt(port), xml, "33000019");
...
//					"<zys>10</zys>" +
//					"<detail>" +
//					"<loancontrcode>XXXX1</loancontrcode>" +
//					"<repaymode>XXX1</repaymode>" +
//					"<termnum>XXX1</termnum>" +
//					"<repaydate>XX1</repaydate>" +
//					"<planprin>XXX1</planprin>" +
//					"<planint>XXX1</planint>" +
//					"</detail>" +
//					"<detail>" +
//					"<loancontrcode>XXXX2</loancontrcode>" +
//					"<repaymode>XXX2</repaymode>" +
//					"<termnum>XXX2</termnum>" +
//					"<repaydate>XX2</repaydate>" +
//					"<planprin>XXX2</planprin>" +
//					"<planint>XXX2</planint>" +
//					"</detail>" +
//					"<detail>" +
//					"<loancontrcode>XXXX3</loancontrcode>" +
//					"<repaymode>XXX3</repaymode>" +
//					"<termnum>XXX3</termnum>" +
//					"<repaydate>XX3</repaydate>" +
//					"<planprin>XXX3</planprin>" +
//					"<planint>XXX3</planint>" +
//					"</detail>" +
//					"</body>" +
//					"</root>";
...
//			HashMap resultMap = MessageCtrMain.analysisPacket(msgType, "D:/server/apache-tomcat-6.0.44/webapps/ydmi_csp/WEB-INF/classes/com/yondervision/yfmap/config/messagetemp/00053100/REP_HKJHCX.xml", rexml, req);
//			log.debug("解析报文MAP："+resultMap);
			...
			if(filename!=null){
				...
				while (line != null) {// 判断读取到的字符串是否不为空
					JiNanAppApi00703Result aa00703Result = new JiNanAppApi00703Result();
					try {
						String[] valus = line.split("\\@\\|\\$");
						log.debug("读取文件  ："+line);									
						aa00703Result.setLoancontrcode(valus[0]);
						aa00703Result.setRepaymode(valus[1]);
						aa00703Result.setTermnum(valus[2]);
						//aa00703Result.setBegdate(valus[3]);
						//aa00703Result.setEnddate(valus[4]);
						aa00703Result.setRepaydate(valus[3]);
						aa00703Result.setPlanprin(valus[4]);
						aa00703Result.setPlanint(valus[5]);
...
//		app007Result.setFreeuse3(String.format("%,.2f",Double.valueOf(app007Result.getFreeuse3())));
		...
		for(int i=0;i<list.size();i++){
			...
			result1 = JavaBeanUtil.javaBeanToListTitleInfoBean("appapi00703"+form.getCenterId()+".result", (JiNanAppApi00703Result)list.get(i));	
			detail.add(result1);
		}
...
//		modelMap.put("enddate", app007Result.getEnddate());	
	...
	public static void main(String[] args){
		...
		Handle00703_00053100 hand = new Handle00703_00053100();
		try {
