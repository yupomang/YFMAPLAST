...
public class Handle00910_00066800 implements CtrlHandleInter {
	Logger log = Logger.getLogger("YFMAP");
	@SuppressWarnings("rawtypes")
	public ModelMap action(AppApiCommonForm form1, ModelMap modelMap) throws CenterRuntimeException,Exception{
		String PROPERTIES_FILE_NAME = "properties.properties";
		AppApi00910Form form = (AppApi00910Form)form1;
		log.debug("00066800请求00910参数："+CommonUtil.getStringParams(form));
		...
		if(Constants.method_BSP.equals(send)){////xml通信处理
			...
			//String xml = MessageCtrMain.encapsulatedPackets(msgType, "E:/mcq/workspaceEclipse/YFMAP/src/com/yondervision/yfmap/config/messagetemp/00073300/BSP_REQ_DKEDSS.txt", map, req);
			...
			//HashMap resultMap = MessageCtrMain.analysisPacket(msgType, "E:/mcq/workspaceEclipse/YFMAP/src/com/yondervision/yfmap/config/messagetemp/00073300/BSP_REP_DKEDSS.txt", rexml, req);
		...
		if ("40".equals(form.getChannel())) {
			...
			modelMap.put("msg", "成功");
			modelMap.put("maxloanamt", app00910ZHResult.getMaxloanamt());
			modelMap.put("maxloanyear", app00910ZHResult.getMaxloanyear());
		} else {
	...
	/*public static void main(String[] args) throws Exception{
		...
		Handle00910_00066800 hand = new Handle00910_00066800();
		try {
