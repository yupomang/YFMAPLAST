...
public class Handle00906_00066800 implements CtrlHandleInter {
	Logger log = Logger.getLogger("YFMAP");
	@SuppressWarnings("rawtypes")
	public ModelMap action(AppApiCommonForm form1, ModelMap modelMap) throws CenterRuntimeException,Exception{
		String PROPERTIES_FILE_NAME = "properties.properties";
		AppApi00907Form form = (AppApi00907Form)form1;
		log.debug("00066800请求00906参数："+CommonUtil.getStringParams(form));
		...
		if(Constants.method_BSP.equals(send)){////xml通信处理
			...
			//String xml = MessageCtrMain.encapsulatedPackets(msgType, "E:/mcq/workspaceEclipse/YFMAP/src/com/yondervision/yfmap/config/messagetemp/00073300/BSP_REQ_HKSSLL.txt", map, req);
			...
			//HashMap resultMap = MessageCtrMain.analysisPacket(msgType, "E:/mcq/workspaceEclipse/YFMAP/src/com/yondervision/yfmap/config/messagetemp/00073300/BSP_REP_HKSSLL.txt", rexml, req);
...
//		BigDecimal bt = busiloanrate.multiply(new BigDecimal(100));
	...
	/*public static void main(String[] args){
		...
		Handle00906_00066800 hand = new Handle00906_00066800();
		try {
