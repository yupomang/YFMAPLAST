...
public class EncryptionByDES extends EncryptionAbs{
	 ...
	 */
	@Override
	public byte[] encryption(String msg,byte[] key) throws Exception{
	 ...
	 */
	@Override
	public String dencryption(byte[] msg,byte[] key) throws Exception{
		int l = msg.length;
		int num = msg.length;
		while( l % 8 != 0 )
		{			
