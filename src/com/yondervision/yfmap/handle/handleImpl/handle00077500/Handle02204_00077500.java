...
import com.yondervision.yfmap.result.guigang.AppApi02204ZHResult;
...
public class Handle02204_00077500 implements CtrlHandleInter{
	...
	public ModelMap action(AppApiCommonForm form1, ModelMap modelMap) throws CenterRuntimeException, Exception {
		...
		if(Constants.method_BSP.equals(send)){////xml通信处理
			...
			//String xml = MessageCtrMain.encapsulatedPackets(msgType, "E:/mcq/workspaceEclipse/YFMAP/src/com/yondervision/yfmap/config/messagetemp/00077500/BSP_REQ_GRXXGGCX.txt", map, req);
			log.debug("前置YFMAP发往中心报文："+xml);			
			String ip = PropertiesReader.getProperty(PROPERTIES_FILE_NAME, "BSP_SOCKET_IP"+form.getCenterId()).trim();
			String port = PropertiesReader.getProperty(PROPERTIES_FILE_NAME, "BSP_SOCKET_PORT"+form.getCenterId()).trim();
			String rexml = CommunicateUtil.sendMessage(send, ip, Integer.parseInt(port), xml, "115001");
			...
			*/
			...
			//HashMap resultMap = MessageCtrMain.analysisPacket(msgType, "E:/mcq/workspaceEclipse/YFMAP/src/com/yondervision/yfmap/config/messagetemp/00077500/BSP_REP_GRXXGGCX.txt", rexml, req);
		...
		//贵港添加
		modelMap.put("xingbie", app02204ZHResult.getXingbie());
		modelMap.put("gddhhm", app02204ZHResult.getGddhhm());
		modelMap.put("csny", app02204ZHResult.getCsny());
		modelMap.put("hyzk", app02204ZHResult.getHyzk());
		modelMap.put("zhiye", app02204ZHResult.getZhiye());
		modelMap.put("zhichen", app02204ZHResult.getZhichen());
		modelMap.put("zhiwu", app02204ZHResult.getZhiwu());
		modelMap.put("xueli", app02204ZHResult.getXueli());
		modelMap.put("yzbm", app02204ZHResult.getYzbm());
		modelMap.put("jtzz", app02204ZHResult.getJtzz());
		modelMap.put("jtysr", app02204ZHResult.getJtysr());
	...
	/*public static void main(String[] args){
		...
		Handle02204_00077500 hand = new Handle02204_00077500();
		try {
