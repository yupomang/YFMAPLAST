...
import com.yondervision.yfmap.result.haikou.AppApi01030Result;
 ...
 *
 */
public class Handle01030_00089800 implements CtrlHandleInter {
	
	Logger log = Logger.getLogger("YFMAP");
	public ModelMap action(AppApiCommonForm form1, ModelMap modelMap) throws CenterRuntimeException,Exception{
		String PROPERTIES_FILE_NAME = "properties.properties";
		AppApi01028Form form = (AppApi01028Form)form1;
		log.info(Constants.LOG_HEAD+"appApi01030 start.");
		...
		AppApi01030Result app01030Result = new AppApi01030Result();
		...
		if(Constants.method_BSP.equals(send)){
			...
			/* 第1次通信  查询提取相关信息*/
			String xml = MessageCtrMain.encapsulatedPackets(msgType, CommonUtil.getFullURL(Constants.msgPath+form.getCenterId())+"/BSP_REQ_YWBLHK124002.txt", map, req);
			log.debug("发往中心报文-提取相关信息获取："+xml);
			
			// 通信
			String rexml = CommunicateUtil.sendMessage(send, ip, Integer.parseInt(port), xml, "124002");
			log.debug("中心返回报文-提取相关信息获取："+rexml);
			
			HashMap resultMap = MessageCtrMain.analysisPacket(msgType,CommonUtil.getFullURL(Constants.msgPath+form.getCenterId())+"BSP_REP_YWBLHK124002.txt", rexml, req);
			...
			BeanUtil.transMap2Bean(resultMap, app01030Result);
		}
		
		List<TitleInfoBean> appapi00101Result = null;
		appapi00101Result = JavaBeanUtil.javaBeanToListTitleInfoBean("appapi01030"+form.getCenterId()+".result", app01030Result);
		...
		modelMap.put("result1", app01030Result);
