 ...
 * 提取信息查询-05-公贷
 */
public class Handle0100605_00031500 implements CtrlHandleInter {
...
//			HashMap resultMap = MessageCtrMain.analysisPacket(msgType, "D:/server/apache-tomcat-6.0.44/webapps/ydmi_csp/WEB-INF/classes/com/yondervision/yfmap/config/messagetemp/00053100/REP_TQYYCX02.xml", rexml, req);
		...
		app01003Result.setDkzje(String.format("%.2f",Double.valueOf(app01003Result.getDkzje()))+"元");
		...
		app01003Result.setDkll((String.format("%.2f",Double.valueOf(app01003Result.getDkll())))+"%");
		...
		List<TitleInfoBean> h_appapi01006Result = JavaBeanUtil.javaBeanToListTitleInfoBean("appapi0100605"+form.getCenterId()+".h_result", app01003Result);
	...
	public static void main(String[] args){
		...
		Handle0100605_00031500 hand = new Handle0100605_00031500();
		try {
