...
public class Handle500_00075800 implements CtrlHandleInter {
	...
	public ModelMap action(AppApiCommonForm form1, ModelMap modelMap)
		...
		if(Constants.method_XML.equals(send)){////xml通信处理
			...
			String rexml = CommunicateUtil.sendMessage(send, ip, Integer.parseInt(port), xml, "A00014");
			...
			if(!"0".equals(app40102Result.getIsloanflag())){
				...
				if(!"0000".equals(app40102Result.getRecode())){
