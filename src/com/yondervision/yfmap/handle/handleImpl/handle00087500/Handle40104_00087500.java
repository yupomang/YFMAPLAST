...
public class Handle40104_00087500 implements CtrlHandleInter {
	...
	public ModelMap action(AppApiCommonForm form1, ModelMap modelMap)
		...
		System.out.println("surplusAccount==after="+surplusAccountTmp);
		form.setAccnum(surplusAccountTmp);
	...
	public static void main(String[] args){
		...
		Handle40104_00087500 hand = new Handle40104_00087500();
		try {
