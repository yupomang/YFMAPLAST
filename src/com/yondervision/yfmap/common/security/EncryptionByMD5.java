...
/**
* @ClassName: EncryptionByMD5 
* @Description: MD5
* @author Caozhongyan
* @date Oct 31, 2013 2:29:25 PM   
* 
*/ 
public class EncryptionByMD5 {
	...
	public static void main(String[] args) throws UnsupportedEncodingException {
		String requestSecret = "acf49d685abe41de821b566498435f75";
		Date date = new Date();
		...
		String sign = getMD5((appKey + requestSecret.toLowerCase() + requestTime).getBytes("UTF-8")).toLowerCase();
