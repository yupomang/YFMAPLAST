...
public class Handle00906_00073300 implements CtrlHandleInter {
	Logger log = Logger.getLogger("YFMAP");
	@SuppressWarnings("rawtypes")
	public ModelMap action(AppApiCommonForm form1, ModelMap modelMap) throws CenterRuntimeException,Exception{
		String PROPERTIES_FILE_NAME = "properties.properties";
		AppApi00907Form form = (AppApi00907Form)form1;
		log.debug("00073300请求00906参数："+CommonUtil.getStringParams(form));
...
//		BigDecimal bt = busiloanrate.multiply(new BigDecimal(100));
	...
	/*public static void main(String[] args){
		...
		Handle00906_00073300 hand = new Handle00906_00073300();
		try {
