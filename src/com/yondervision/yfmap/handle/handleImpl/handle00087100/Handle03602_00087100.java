...
//			String xml = MessageCtrMain.encapsulatedPackets(msgType, "D:/java/apache-tomcat-7.0.8-windows-x64/apache-tomcat-7.0.8/webapps/ydmi_csp/WEB-INF/classes/com/yondervision/yfmap/config/messagetemp/00087100/BSP_REQ_WTDZHKCL.txt", map, req);
...
//		    HashMap resultMap = MessageCtrMain.analysisPacket(msgType, "D:/java/apache-tomcat-7.0.8-windows-x64/apache-tomcat-7.0.8/webapps/ydmi_csp/WEB-INF/classes/com/yondervision/yfmap/config/messagetemp/00087100/BSP_REP_WTDZHKCL.txt", rexml, req);
		...
		modelMap.put("acc_flag", app03602ZHResult.getAcc_flag());
		modelMap.put("acc_amt", app03602ZHResult.getAcc_amt());
		log.info("【资金类业务03602】-------【end】");
		return modelMap;
	}
