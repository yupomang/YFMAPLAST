...
public class Handle02303_00073300  implements CtrlHandleInter {
	Logger log = Logger.getLogger("YFMAP");
	public ModelMap action(AppApiCommonForm form1, ModelMap modelMap) throws CenterRuntimeException,Exception{
		AppApi020Form form = (AppApi020Form)form1;
		String PROPERTIES_FILE_NAME = "properties.properties";
		log.debug("00073300请求02303参数："+CommonUtil.getStringParams(form));
...
//110059交易end
	...
	/*public static void main(String[] args){
		...
		Handle02303_00073300 hand = new Handle02303_00073300();
		try {
