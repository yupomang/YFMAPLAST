 ...
 * 短信签约状态查询
 */
public class Handle41201_00053100 implements CtrlHandleInter {
...
//				return modelMap;
//			}
			String xml = MessageCtrMain.encapsulatedPackets(msgType, CommonUtil.getFullURL(Constants.msgPath+form.getCenterId())+"REQ_DXQYCX.xml", map, req);
			//String xml = MessageCtrMain.encapsulatedPackets(msgType, "D:/server/apache-tomcat-6.0.44/webapps/ydmi_csp/WEB-INF/classes/com/yondervision/yfmap/config/messagetemp/00053100/REQ_DXQYCX.xml", map, req);
			...
			String rexml = CommunicateUtil.sendMessage(send, ip, Integer.parseInt(port), xml, "33000016");
...
//			String rexml = "<?xml version=\"1.0\" encoding = \"UTF-8\"?><root><head><reqflag>1</reqflag><msgtype>79</msgtype><tr_code>X00009</tr_code><corp_no>00053100</corp_no>" +
...
//					"</body></root>";
			...
			HashMap resultMap = MessageCtrMain.analysisPacket(msgType, CommonUtil.getFullURL(Constants.msgPath+form.getCenterId())+"REP_DXQYCX.xml", rexml, req);
//			HashMap resultMap = MessageCtrMain.analysisPacket(msgType, "D:/server/apache-tomcat-6.0.44/webapps/ydmi_csp/WEB-INF/classes/com/yondervision/yfmap/config/messagetemp/00053100/REP_DXQYCX.xml", rexml, req);
		...
		obj.put("signPhoneNumber",app41201Result.getSignPhoneNumber().replaceAll("--", ""));
		obj.put("endDate",app41201Result.getEndDate().replaceAll("--", ""));
		obj.put("loanaccnum",aes.encrypt(app41201Result.getLoanaccnum().replaceAll("--", "").getBytes("UTF-8")));
	...
	public static void main(String[] args){
		...
		Handle41201_00053100 hand = new Handle41201_00053100();
		try {
