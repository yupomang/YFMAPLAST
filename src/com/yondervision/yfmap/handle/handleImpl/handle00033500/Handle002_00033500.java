...
public class Handle002_00033500 implements CtrlHandleInter {
...
//			String reqxml = "<?xml version=\"1.0\" encoding=\"GBK\"?><root><head><tr_code>700001</tr_code><corp_no>00000001</corp_no><req_no>10000000001</req_no><serial_no>1</serial_no><ans_no>1</ans_no><next_no>1</next_no><tr_acdt>1</tr_acdt><tr_time>1</tr_time><ans_code>00</ans_code><ans_info>111</ans_info><particular_code>1</particular_code><atom_tr_count></atom_tr_count><reserved>1</reserved><particular_info>1</particular_info></head><body><pageNo>1</pageNo><pageSize>30</pageSize><detail><transdate>2015-10-10</transdate><busitype>2</busitype><payamt>3</payamt><incomamt>4</incomamt><bal>5</bal></detail><detail><transdate>2015-10-10</transdate><busitype>2</busitype><payamt>3</payamt><incomamt>4</incomamt><bal>5</bal></detail></body></root>";
//			String reqxml = "<TranCode>600015</><TranDate>2014-04-21</><STimeStamp>2014-05-13 09:33:48</><MTimeStamp>2014-05-13 09:33:48</><BrcCode>00063000</><TellCode>6000</><ChkCode>1231</><AuthCode1>1231</><AuthCode2>1231</><AuthCode3>1231</><TranChannel>11</><TranIP>192.168.3.221</><ChannelSeq>-4927</><TranSeq>0</><BusiSeq>0</><RspCode>000000</><RspMsg>交易处理成功...</><NoteMsg></><AuthFlag>123112310</><FinancialDate>2014-01-05</><HostBank>aaa</><SubBank>aaa</><AccNum>00265744</><CertiNum>370620196207240511</><UnitAccNum>000341</><AccName>迟健</><_DOWNFILENAME>2014-04-21/downfile/lnque002.0</><AmtSum1>0.00</><OpenDate>1996-07-01</><Balance>0.00</><UnitAccName>威海市旅游码头有限责任公司</><AmtSum2>7063.30</>";
				...
				while (line != null) {// 判断读取到的字符串是否不为空
					...
					try {
						...
						if(!"@|$".equals(line.trim())){
							...
							System.out.println("param[0]:"+param[0]+"    param[1]:"+param[1]+"   param[2]:"+param[2]+"   param[3]:"+param[3]+"   param[4]:"+param[4]);
		...
		for(int i=0;i<list.size();i++){
			...
			result.add(result1);
			System.out.println("result.add(result1):"+result1);
		}
		/***************************************************肇庆 201407***********************************/
