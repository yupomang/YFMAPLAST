...
public class Handle00703_00047201 implements CtrlHandleInter {
	...
	public ModelMap action(AppApiCommonForm form1, ModelMap modelMap) throws CenterRuntimeException,Exception{
		...
		List<BaoGangAppApi00703Result> list = new ArrayList<BaoGangAppApi00703Result>();
		...
		BaoGangAppApi00703Result app002Result = new BaoGangAppApi00703Result();
		if(Constants.method_BSP.equals(send)){////xml通信处理
			...
			String reqxml = CommunicateUtil.sendMessage(send, ip, Integer.parseInt(port), xml, "123441");
...
//				}
				int i = 0;
				while (line != null) {
					BaoGangAppApi00703Result aa00201Result = new BaoGangAppApi00703Result();
					try {
...
//							if(sum>num){
							if(i!=0){
								...
								log.debug("读取文件  ："+line);
								aa00201Result.setSeqnum1(param[0].trim());						
								aa00201Result.setEnddate(param[1].trim());
								aa00201Result.setInfactdate(param[2].trim());						
								aa00201Result.setFirstloanbal(param[3].trim());	
								aa00201Result.setAmt(param[4].trim());						
								aa00201Result.setPlanprin(param[5].trim());
								aa00201Result.setPlanint(param[6].trim());						
								aa00201Result.setOweprin(param[7].trim());	
								aa00201Result.setOweint(param[8].trim());
								aa00201Result.setCurseqstate(param[9].trim());
								aa00201Result.setAcTransCode(param[10].trim());
