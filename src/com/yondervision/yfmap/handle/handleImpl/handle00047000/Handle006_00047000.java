...
import com.yondervision.yfmap.result.hulunbuir.HulunbuirAppApi00601Result;
...
public class Handle006_00047000 implements CtrlHandleInter {
	...
	public ModelMap action(AppApiCommonForm form1, ModelMap modelMap)
		...
		log.debug("form:"+form); 
		HulunbuirAppApi00601Result app00601Result= new HulunbuirAppApi00601Result();
...
//			String reqxml = "<RspCode>E87007</><RspMsg>合同代码[]不存在</><TranSeq>726</>";
		...
		app00601Result.setApploanterm(app00601Result.getApploanterm()+"（月）");
		app00601Result.setLoanrate(app00601Result.getLoanrate()+"%");
