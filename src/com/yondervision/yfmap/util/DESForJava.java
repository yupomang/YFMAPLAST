...
public class DESForJava {
	...
	public static void main(String[] args) throws UnsupportedEncodingException {
		...
		byte[] encKey = DESForJava.keydes("12345678".getBytes(), "12345678".getBytes(), 8, 0);
		String encKeyS = new String(encKey);
		System.out.println(">>>"+encKeyS);
		byte[] decKey = DESForJava.keydes(encKeyS.getBytes(), "12345678".getBytes(), 8, 1);
		System.out.println(new String(decKey));
		
		String key = "12345678";
		String s="105457";
		byte[] b = DESForJava.encryption(s, key);
		byte[] c=bcd_to_asc(b);
		System.out.println(">>>>>ssss"+new String(c));
		int i = c.length;
		byte[] d=asc_to_bcd(c,i);
		String kk = DESForJava.decryption(d, key);
		...
		b = DESForJava.encryption(kkk, "1234567812345678");
		kk = DESForJava.decryption(b, "1234567812345678");
