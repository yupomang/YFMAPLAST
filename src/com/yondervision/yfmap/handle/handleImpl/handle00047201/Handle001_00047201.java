...
/** 
* @ClassName: Handle001_00047201 
* @Description: 公积金信息查询
* 
*/ 
public class Handle001_00047201 implements CtrlHandleInter {
	...
	public ModelMap action(AppApiCommonForm form1, ModelMap modelMap) throws CenterRuntimeException,Exception{
		...
		BaoGangAppApi00101Result app40101Result = new BaoGangAppApi00101Result();
		if(Constants.method_BSP.equals(send)){////xml通信处理
			...
			String rexml = CommunicateUtil.sendMessage(send, ip, Integer.parseInt(port), xml, "311602");
