...
import com.yondervision.yfmap.result.chengde.ChengDeAppApi00601Result;
 ...
 * 贷款情况查询
 */
public class Handle006_00031400 implements CtrlHandleInter {
	...
	public ModelMap action(AppApiCommonForm form1, ModelMap modelMap)
		...
		log.debug("form:"+form); 
		/* 模拟返回开始  */
		ChengDeAppApi00601Result app00601Result= new ChengDeAppApi00601Result();
...
//			HashMap resultMap = MessageCtrMain.analysisPacket(msgType, "C:/Program Files/Tomcat 6.0/webapps/YFMAP/WEB-INF/classes/com/yondervision/yfmap/config/messagetemp/00053100/REP_DKYECX.xml", rexml, req);
		...
		//app00601Result.setOverdueamt(String.format("%.2f",Double.valueOf(app00601Result.getOverdueamt())));
		app00601Result.setYqbj(String.format("%.2f",Double.valueOf(app00601Result.getYqbj())));
		app00601Result.setYqlx(String.format("%.2f",Double.valueOf(app00601Result.getYqlx())));
		app00601Result.setYqfx(String.format("%.2f",Double.valueOf(app00601Result.getYqfx())));
	...
	public static void main(String[] args){
		...
		Handle006_00031400 hand = new Handle006_00031400();
		try {
