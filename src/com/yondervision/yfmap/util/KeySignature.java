...
public class KeySignature {
    ...
    public static byte[] keySign(byte[] data){
    	String password = PropertiesReader.getProperty("properties.properties", "miappkey").trim();   
        String alias = PropertiesReader.getProperty("properties.properties", "alias").trim();
        String keyStorePath = PropertiesReader.getProperty("properties.properties", "keyStorePath").trim();
        byte[] sign = null;
        try {
			 sign = KeySignature.sign(data, keyStorePath, alias, password);			
		} catch (Exception e) {
    ...
    public static String urlToString(String value){    	
