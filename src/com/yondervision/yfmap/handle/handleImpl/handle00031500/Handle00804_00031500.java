...
public class Handle00804_00031500 implements CtrlHandleInter {
	...
	public ModelMap action(AppApiCommonForm form1, ModelMap modelMap) throws CenterRuntimeException,Exception{
		...
		TangShanAppApi00804_1Result app00802Result = new TangShanAppApi00804_1Result();
		List<TangShanAppApi00804_2Result> list = new ArrayList<TangShanAppApi00804_2Result>();
		...
		log.debug("YFMAP 可贷楼盘区域查询 楼盘名称 参数:"+form.getSelectValue());
		if(Constants.method_XML.equals(send)){
			...
			String xml = MessageCtrMain.encapsulatedPackets(msgType, CommonUtil.getFullURL(Constants.msgPath+form.getCenterId())+"/REQ_KDLPQYCX.xml", map, req);
...
//			String rexml = "<?xml version=\"1.0\" encoding = \"UTF-8\"?><root><head><reqflag>1</reqflag><msgtype>76</msgtype><tr_code>X00006</tr_code><corp_no>00053100</corp_no><oreq_no>8020150929007169</oreq_no><tr_acdt>2015-09-29</tr_acdt><tr_time>10:25:15</tr_time><ans_code>000000</ans_code><ans_info>交易成功完成</ans_info><particular_code>000000</particular_code><particular_info>交易成功完成</particular_info><reserved></reserved></head><body><dqys>1</dqys><dqysjls>10</dqysjls><zjls>5</zjls><zys>1</zys><detail><lpmc>德润天玺B1地块</lpmc><wdmc>兴业银行分行个贷中心</wdmc><kfdw>济南德润房地产开发有限公司</kfdw><pzzh>2（商业除外）,4,7,9（商业除外）</pzzh></detail><detail><lpmc>德润天玺B1地块</lpmc><wdmc>兴业银行分行个贷中心</wdmc><kfdw>K5,K6,K11</kfdw><pzzh>2（商业除外）,4,7,9（商业除外）</pzzh></detail><detail><lpmc>德润天玺B1地块</lpmc><wdmc>兴业银行分行个贷中心</wdmc><kfdw>6号楼,8号楼,11号楼,13号楼,14号楼,15号楼,16号楼</kfdw><pzzh>2（商业除外）,4,7,9（商业除外）</pzzh></detail><detail><lpmc>德润天玺B1地块</lpmc><wdmc>兴业银行分行个贷中心</wdmc><kfdw>1（3-25层）,5（3-25层、1-101、1-102、1-103、1-104、1-201、1-202、1-203、</kfdw><pzzh>2（商业除外）,4,7,9（商业除外）</pzzh></detail><detail><lpmc>德润天玺B1地块</lpmc><wdmc>兴业银行分行个贷中心</wdmc><kfdw>1（3-25层）,5（3-25层、1-101、1-102、1-103、1-104、1-201、1-202、1-203、,3号楼,4号楼</kfdw><pzzh>2（商业除外）,4,7,9（商业除外）</pzzh></detail></body></root>";
			...
			HashMap resultMap = MessageCtrMain.analysisPacket(msgType,CommonUtil.getFullURL(Constants.msgPath+form.getCenterId())+"REP_KDLPQYCX.xml", rexml, req);
//			HashMap resultMap = MessageCtrMain.analysisPacket(msgType,"C:/Program Files/Tomcat 6.0/webapps/YFMAP/WEB-INF/classes/com/yondervision/yfmap/config/messagetemp/00053100/REP_KDLPCX.xml", rexml, req);
			...
			System.out.println("查询可贷区域，批量文件："+filename);
			if(filename!=null){
				...
				while (line != null) {// 判断读取到的字符串是否不为空
					TangShanAppApi00804_2Result aa00804Result = new TangShanAppApi00804_2Result();
					try {
						String[] valus = line.split("\\@\\|\\$");
						log.debug("读取文件  ："+line);
						aa00804Result.setQymc(valus[0]);
						list.add(aa00804Result);
		...
		for(int i=0;i<list.size();i++){
			appapi00802Detail = JavaBeanUtil.javaBeanToListTitleInfoBean("appapi00804"+form.getCenterId()+".detail", list.get(i));			
...
//		System.out.println(JsonUtil.getGson().toJson(modelMap));
	...
	public static void main(String[] args) throws Exception{
		String xml = "<?xml version=\"1.0\" encoding=\"gbk\"?><root><head><reqflag>1</reqflag><msgtype>78</msgtype><tr_code>X00008</tr_code><corp_no>00031500</corp_no><oreq_no>20170223112644829</oreq_no><tr_acdt>2017-02-23</tr_acdt><tr_time>11:26:44</tr_time><ans_code>0</ans_code><ans_info>交易处理成功...</ans_info><particular_code>0000</particular_code><particular_info>交易处理成功...</particular_info><reserved></reserved></head><body><dqys>1</dqys><dqysjls>10</dqysjls><zjls>104</zjls><zys>11</zys><detail><lpmc>浭阳华府</lpmc><wdmc>丰润</wdmc><kfdw>唐山中冶万城房地产开发有限公司</kfdw><pzzh>207</pzzh></detail><detail><lpmc>浭阳华府</lpmc><wdmc>丰润</wdmc><kfdw>唐山中冶万城房地产开发有限公司</kfdw><pzzh>208，209，210</pzzh></detail><detail><lpmc>浭阳华府</lpmc><wdmc>丰润</wdmc><kfdw>唐山中冶万城房地产开发有限公司</kfdw><pzzh>106，107，108，109</pzzh></detail><detail><lpmc>浭阳华府</lpmc><wdmc>丰润</wdmc><kfdw>唐山中冶万城房地产开发有限公司</kfdw><pzzh>111，112</pzzh></detail><detail><lpmc>浭阳华府</lpmc><wdmc>丰润</wdmc><kfdw>唐山中冶万城房地产开发有限公司</kfdw><pzzh>115，116，212</pzzh></detail><detail><lpmc>浭阳华府</lpmc><wdmc>丰润</wdmc><kfdw>唐山中冶万城房地产开发有限公司</kfdw><pzzh>117，213，215，216</pzzh></detail><detail><lpmc>浭阳佳苑</lpmc><wdmc>丰润</wdmc><kfdw>唐山中冶万城房地产开发有限公司</kfdw><pzzh>1，2，3，4，5</pzzh></detail><detail><lpmc>浭阳乐郡</lpmc><wdmc>丰润</wdmc><kfdw>唐山市中冶万城房地产开发有限公司</kfdw><pzzh>7，8</pzzh></detail><detail><lpmc>浭阳诗苑A-2-3项目</lpmc><wdmc>丰润</wdmc><kfdw>唐山中冶万城房地产开发有限公司</kfdw><pzzh>1，2，3，4</pzzh></detail><detail><lpmc>浭阳新城A-4-2地块</lpmc><wdmc>丰润</wdmc><kfdw>唐山燕东房地产开发有限公司</kfdw><pzzh>1，2，3，4，5，6</pzzh></detail></body></root>";
		HashMap resultMap = MessageCtrMain.analysisPacket("2","D:\\tomcat\\webapps\\ydmi_csp\\WEB-INF\\classes\\com\\yondervision\\yfmap\\config\\messagetemp\\00031500\\REP_KDLPCX.xml", xml, "");
//		String filename = (String)resultMap.get(MessageCtrMain.RECEIVE_FILE_NAME_KEY);
//		System.out.println("查询可贷区域，批量文件："+filename);
//		File filemx = new File(filename);//File(ReadProperties.getString("bsp_local_path")+form.getSendDate()+"/"+fname);
//		FileInputStream ffis = new FileInputStream(filemx);
