...
/** 
* @ClassName: Handle0091702_00047201 
* @Description: 贷款额度试算——配偶在包钢缴存
* 
*/ 
public class Handle0091702_00047201 implements CtrlHandleInter {
	...
	public ModelMap action(AppApiCommonForm form1, ModelMap modelMap) throws CenterRuntimeException,Exception{
		...
		log.debug("贷款额度试算——配偶在包钢缴存请求参:"+form);
