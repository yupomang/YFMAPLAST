...
public class Handle401_00091200 implements CtrlHandleInter {
	...
	public ModelMap action(AppApiCommonForm form1, ModelMap modelMap)
		...
		if(Constants.method_XML.equals(send)){////xml通信处理
			...
			//String rexml ="<root><head><tr_code>430401</tr_code><corp_no></corp_no><req_no></req_no><serial_no></serial_no><ans_no>724</ans_no><next_no></next_no><tr_acdt>20160608</tr_acdt><tr_time>012343</tr_time><ans_code>99</ans_code><ans_info>该证件号无正常公积金账号!</ans_info><particular_code></particular_code><atom_tr_count></atom_tr_count><reserved></reserved><particular_info></particular_info></head><body><accname></accname><certinum></certinum><validflag></validflag><accnum></accnum></body></root>";
			...
			//HashMap resultMap = MessageCtrMain.analysisPacket(msgType, "D:/tomcat6.0.14/webapps/ydmi_csp/WEB-INF/classes/com/yondervision/yfmap/config/messagetemp/00091200/REP_DL.xml", rexml, req);
	...
	public static void main(String[] args){
		...
		Handle401_00091200 hand = new Handle401_00091200();
		try {
