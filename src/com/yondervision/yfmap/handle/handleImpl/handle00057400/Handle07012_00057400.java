...
public class Handle07012_00057400 implements CtrlHandleInter {
...
//				form.setBrcCode(PropertiesReader.getProperty(PROPERTIES_FILE_NAME, "appapi001BrcCode"+form.getCenterId()).trim());
		    ...
		    String xml = MessageCtrMain.encapsulatedPackets(msgType, CommonUtil.getFullURL(Constants.msgPath+form.getCenterId())+"/BSP_REQ_07012_128113.txt", map, req);
			log.debug("前置YFMAP发往中心报文："+xml);
			String ip = PropertiesReader.getProperty(PROPERTIES_FILE_NAME, "BSP_SOCKET_IP"+form.getCenterId()).trim();
			String port = PropertiesReader.getProperty(PROPERTIES_FILE_NAME, "BSP_SOCKET_PORT"+form.getCenterId()).trim();
			String rexml = CommunicateUtil.sendMessage(send, ip, Integer.parseInt(port), xml, "128113");
			log.debug("前置YFMAP接收中心报文——柜台还款-个人账号查询公积金信息："+rexml);
		    HashMap resultMap = MessageCtrMain.analysisPacket(msgType, CommonUtil.getFullURL(Constants.msgPath+form.getCenterId())+"/BSP_REP_07012_128113.txt", rexml, req);
		...
		modelMap.put("msg", "成功");
		modelMap.put("accname",app07010ZHResult.getAccname());
		modelMap.put("certinum",app07010ZHResult.getCertinum());
		modelMap.put("certitype",app07010ZHResult.getCertitype());
		modelMap.put("unitaccnum",app07010ZHResult.getUnitaccnum());
		modelMap.put("usebal",app07010ZHResult.getUsebal());
		return modelMap;
	}
}
