...
public class Handle02205_00057400 implements CtrlHandleInter {
	...
	public ModelMap action(AppApiCommonForm form1, ModelMap modelMap) throws CenterRuntimeException,Exception{
		...
		log.debug("00057400请求02205参数："+CommonUtil.getStringParams(form));
...
//				form.setBrcCode(PropertiesReader.getProperty(PROPERTIES_FILE_NAME, "appapi001BrcCode"+form.getCenterId()).trim());
			...
			String xml = MessageCtrMain.encapsulatedPackets(msgType, CommonUtil.getFullURL(Constants.msgPath+form.getCenterId())+"/BSP_REQ_GRBGJLCX.txt", map, req);
			//String xml = MessageCtrMain.encapsulatedPackets(msgType, "D:/workzone/YFMAP/src/com/yondervision/yfmap/config/messagetemp/00057400/BSP_REQ_GRBGJLCX.txt", map, req);
			log.debug("前置YFMAP发往中心报文："+xml);
			
			String ip = PropertiesReader.getProperty(PROPERTIES_FILE_NAME, "BSP_SOCKET_IP"+form.getCenterId()).trim();
			String port = PropertiesReader.getProperty(PROPERTIES_FILE_NAME, "BSP_SOCKET_PORT"+form.getCenterId()).trim();
			String rexml = CommunicateUtil.sendMessage(send, ip, Integer.parseInt(port), xml, "111409");
			
			//String rexml ="<AuthCode1>9711</><AuthCode2>9711</><AuthCode3>9711</><AuthFlag></><BrcCode>05740008</><BusiSeq>89663</><ChannelSeq>12351771</><ChkCode>9711</><MTimeStamp>2017-08-05 17:15:14:851000</><NoteMsg></><RspCode>000000</><RspMsg>交易处理成功...</><STimeStamp>2017-08-05 17:15:14:849000</><TellCode>9711</><TranChannel>00</><TranCode>111409</><TranDate>2017-08-10</><TranIP>172.16.8.100</><TranSeq>89663</><consum>99</><rsufilename>GRBGJLCX_010100000075_20170810</><rsufilepath>/bsptest/</>";
			
			log.debug("前置YFMAP接收中心报文——单位账户发生额明细批量查询下载："+rexml);
			resultMap = MessageCtrMain.analysisPacket(msgType, CommonUtil.getFullURL(Constants.msgPath+form.getCenterId())+"/BSP_REP_GRBGJLCX.txt", rexml, req);
			//resultMap = MessageCtrMain.analysisPacket(msgType, "D:/workzone/YFMAP/src/com/yondervision/yfmap/config/messagetemp/00057400/BSP_REP_GRBGJLCX.txt", rexml, req);
...
/*	public static void main(String[] args){
		...
		Handle02205_00057400 hand = new Handle02205_00057400();
		try {
