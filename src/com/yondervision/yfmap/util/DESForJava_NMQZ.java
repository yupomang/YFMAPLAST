...
public class DESForJava_NMQZ {
	...
	public static void main(String[] args) throws UnsupportedEncodingException {
		...
		// 密钥的加密解密
//		byte[] encKey = t.keydes("12345678".getBytes(), "12345678".getBytes(), 8, 0);
//		String encKeyS = new String(encKey);
//		System.out.println(">>>"+encKeyS);
//		byte[] decKey = t.keydes(encKeyS.getBytes(), "12345678".getBytes(), 8, 1);
//		System.out.println(new String(decKey));
//		
//		String key = "12345678";
//		
//		byte[] b = t.encryption("000000  ", key);
//		byte[] c=bcd_to_asc(b);
//		System.out.println(">>>>>ssss"+new String(c));
//		int i = c.length;
//		byte[] d=asc_to_bcd(c,i) ;
//		String kk = t.decryption(d, key);
...
//		b = t.encryption(kkk, "1234567812345678");
//		kk = t.decryption(b, "1234567812345678");
//		System.out.println(b.length);
//		System.out.println(kk);
		
		byte[] b = encryption("123456", "12345678");
		byte[] c = bcd_to_asc(b);
